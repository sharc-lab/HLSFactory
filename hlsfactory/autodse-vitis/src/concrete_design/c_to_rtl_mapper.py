        ...
        def _create_parent_mapping(node_name, path):
            ...
            if node_legalized in self.final_mappings:
                ...
                return {
                    ...
                    "c_line": existing_mapping.get("c_line", existing_mapping.get("start_lines")),
                    "start_line": existing_mapping.get("start_line", existing_mapping.get("start_lines")),
                    "end_line": existing_mapping.get("end_line", existing_mapping.get("end_lines")),
