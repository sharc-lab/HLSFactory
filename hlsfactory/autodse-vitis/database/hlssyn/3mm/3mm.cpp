#include "3mm.h"
void kernel_3mm(int ni, int nj, int nk, int nl, int nm, double E[40][50],
                double A[40][60], double B[60][50], double F[50][70],
                double C[50][80], double D[80][70], double G[40][70]) {
  double E_buf[40][50];
  double A_buf[40][60];
  double B_buf[60][50];
  double F_buf[50][70];
