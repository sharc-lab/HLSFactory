...
int main() {
    ...
    // Print top-left 5×5 of reference and HLS outputs
    printf("Reference C (5×5):\n");
    for(int i = 0; i < 5; i++) {
        for(int j = 0; j < 5; j++) {
            printf("%8.4f ", C_ref[i][j].to_float());
        }
        printf("\n");
    }
    ...
    for(int i = 0; i < 5; i++) {
        for(int j = 0; j < 5; j++) {
            printf("%8.4f ", C_HLS[i][j].to_float());
        }
        printf("\n");
    }
