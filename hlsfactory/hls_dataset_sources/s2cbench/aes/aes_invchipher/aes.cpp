...
/************************************************************/
int  aes::Computing(int *data, int *sboxs)
{
  int i;
...
void  aes::SubBytes(int *data, const int sboxs[256])
{
  int i,j;
  unsigned char cb[4];
  int wrk;
...
int aes::dataget(int *data,int n) {
  int ret;
...
void  aes::AddRoundKey(int *data, int n)
{
  int i,m;
...
int  aes::SubWord(int word, const int Sbox[256])
{
  int inw=word;
  int i;
...
/************************************************************/
void aes::KeyExpansion(sc_uint<8> *key, int const Sbox[256])
{
