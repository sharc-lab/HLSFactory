...
int32_t main(int argc, char **argv) {
  ...
  loop0: for (int v6 = 0; v6 < 1; v6++) {	// L11
    loop1: for (int v7 = 0; v7 < 16; v7++) {	// L12
      loop2: for (int v8 = 0; v8 < 56; v8++) {	// L13
        loop3: for (int v9 = 0; v9 < 56; v9++) {	// L14
          float v10 = v3[v6][v7][v8][v9];	// L15
          float v11 = v5[v6][v7][v8][v9];	// L16
          float v12 = v10 - v11;	// L17
          float v13 = v11 - v10;	// L18
          bool v14 = v12 > 0.010000;	// L20
          bool v15 = v13 > 0.010000;	// L21
