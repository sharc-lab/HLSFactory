...
void node1(
  ...
  #pragma HLS array_partition variable=v8 cyclic dim=2 factor=4
        ...
        loop7: for (int v16 = 0; v16 < 4; v16++) {
          loop8: for (int v17 = 0; v17 < 4; v17++) {
            loop9: for (int v18 = 0; v18 < 4; v18++) {
              if ((v17 + (v14 * 4)) == 0) {
                float v19 = v7[v16][v18].read();
                v12[(v16 + (v13 * 4))][(v18 + (v15 * 4))] = v19;
              }
              float v20 = v12[(v16 + (v13 * 4))][(v18 + (v15 * 4))];
              float v21 = v8[(v18 + (v15 * 4))][(v17 + (v14 * 4))];
              if ((v18 + (v15 * 4)) == 0) {
                v11[(v16 + (v13 * 4))][(v17 + (v14 * 4))] = v10;
              }
              float v22 = v11[(v16 + (v13 * 4))][(v17 + (v14 * 4))];
              float v23 = v20 * v21;
              float v24 = v22 + v23;
              v11[(v16 + (v13 * 4))][(v17 + (v14 * 4))] = v24;
              if (((v18 + (v15 * 4)) - 63) == 0) {
                float v25 = v11[(v16 + (v13 * 4))][(v17 + (v14 * 4))];
...
void node2(
  ...
  #pragma HLS array_partition variable=v27 cyclic dim=2 factor=4
        ...
        loop13: for (int v35 = 0; v35 < 4; v35++) {
          loop14: for (int v36 = 0; v36 < 4; v36++) {
            loop15: for (int v37 = 0; v37 < 4; v37++) {
              ...
              float v40 = v27[(v37 + (v34 * 4))][(v36 + (v33 * 4))];
              if ((v37 + (v34 * 4)) == 0) {
                v30[(v35 + (v32 * 4))][(v36 + (v33 * 4))] = v29;
              }
              float v41 = v30[(v35 + (v32 * 4))][(v36 + (v33 * 4))];
              float v42 = v39 * v40;
              float v43 = v41 + v42;
              v30[(v35 + (v32 * 4))][(v36 + (v33 * 4))] = v43;
              if (((v37 + (v34 * 4)) - 63) == 0) {
                float v44 = v30[(v35 + (v32 * 4))][(v36 + (v33 * 4))];
        ...
        loop25: for (int v73 = 0; v73 < 4; v73++) {
          loop26: for (int v74 = 0; v74 < 4; v74++) {
            loop27: for (int v75 = 0; v75 < 4; v75++) {
              if ((v74 + (v71 * 4)) == 0) {
                float v76 = v65[v73][v75].read();
                v69[(v73 + (v70 * 4))][(v75 + (v72 * 4))] = v76;
              }
              float v77 = v69[(v73 + (v70 * 4))][(v75 + (v72 * 4))];
              float v78 = v64[(v75 + (v72 * 4))][(v74 + (v71 * 4))];
              if ((v75 + (v72 * 4)) == 0) {
        ...
        loop31: for (int v92 = 0; v92 < 4; v92++) {
          loop32: for (int v93 = 0; v93 < 4; v93++) {
            loop33: for (int v94 = 0; v94 < 4; v94++) {
              if ((v93 + (v90 * 4)) == 0) {
                float v95 = v83[v92][v94].read();
                v88[(v92 + (v89 * 4))][(v94 + (v91 * 4))] = v95;
              }
              float v96 = v88[(v92 + (v89 * 4))][(v94 + (v91 * 4))];
              float v97 = v84[(v94 + (v91 * 4))][(v93 + (v90 * 4))];
              if ((v94 + (v91 * 4)) == 0) {
                v87[(v92 + (v89 * 4))][(v93 + (v90 * 4))] = v86;
              }
              float v98 = v87[(v92 + (v89 * 4))][(v93 + (v90 * 4))];
              float v99 = v96 * v97;
              float v100 = v98 + v99;
              v87[(v92 + (v89 * 4))][(v93 + (v90 * 4))] = v100;
              if (((v94 + (v91 * 4)) - 63) == 0) {
                float v101 = v87[(v92 + (v89 * 4))][(v93 + (v90 * 4))];
        ...
        loop43: for (int v129 = 0; v129 < 4; v129++) {
          loop44: for (int v130 = 0; v130 < 4; v130++) {
            loop45: for (int v131 = 0; v131 < 4; v131++) {
              float v132 = v121[(v129 + (v126 * 4))][(v131 + (v128 * 4))];
              float v133 = v122[(v131 + (v128 * 4))][(v130 + (v127 * 4))];
              if ((v131 + (v128 * 4)) == 0) {
