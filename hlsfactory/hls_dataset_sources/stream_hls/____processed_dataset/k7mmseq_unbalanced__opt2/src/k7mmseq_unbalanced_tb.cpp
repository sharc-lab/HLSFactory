...
//   std::cout << "PRJ_PATH: " << prj_path_str << std::endl;
  ...
  if (input_0ifs.is_open()) {
    input_0ifs.read((char*)v0, 2048 * sizeof(float));
  } else {
  ...
  if (input_1ifs.is_open()) {
    input_1ifs.read((char*)v1, 2048 * sizeof(float));
  } else {
  ...
  if (input_4ifs.is_open()) {
    input_4ifs.read((char*)v4, 16384 * sizeof(float));
  } else {
  ...
  if (input_5ifs.is_open()) {
    input_5ifs.read((char*)v5, 8192 * sizeof(float));
  } else {
  ...
  if (input_6ifs.is_open()) {
    input_6ifs.read((char*)v6, 2048 * sizeof(float));
  } else {
  ...
  if (input_7ifs.is_open()) {
    input_7ifs.read((char*)v7, 512 * sizeof(float));
  } else {
