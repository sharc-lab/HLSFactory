...
void node2(
  ...
  loop4: for (int v15 = 0; v15 < 41; v15++) {
    loop5: for (int v16 = 0; v16 < 26; v16++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      loop6: for (int v17 = 0; v17 < 10; v17++) {
        loop7: for (int v18 = 0; v18 < 15; v18++) {
          float v19 = v10[(v17 + (v15 * 10))][(v18 + (v16 * 15))];
          float v20 = v11[(v18 + (v16 * 15))];
          if ((v18 + (v16 * 15)) == 0) {
            v14[(v17 + (v15 * 10))] = v13;
          }
          float v21 = v14[(v17 + (v15 * 10))];
          float v22 = v19 * v20;
          float v23 = v21 + v22;
          v14[(v17 + (v15 * 10))] = v23;
          if (((v18 + (v16 * 15)) - 389) == 0) {
            float v24 = v14[(v17 + (v15 * 10))];
            v12[v17].write(v24);
          }
        }
      }
...
void node3(
  ...
  loop8: for (int v30 = 0; v30 < 26; v30++) {
    loop9: for (int v31 = 0; v31 < 41; v31++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      loop10: for (int v32 = 0; v32 < 15; v32++) {
        loop11: for (int v33 = 0; v33 < 10; v33++) {
          float v34 = v25[(v33 + (v31 * 10))];
          float v35 = v26[(v33 + (v31 * 10))][(v32 + (v30 * 15))];
          if ((v33 + (v31 * 10)) == 0) {
            v29[(v32 + (v30 * 15))] = v28;
          }
          float v36 = v29[(v32 + (v30 * 15))];
          float v37 = v34 * v35;
          float v38 = v36 + v37;
          v29[(v32 + (v30 * 15))] = v38;
          if (((v33 + (v31 * 10)) - 409) == 0) {
            float v39 = v29[(v32 + (v30 * 15))];
            v27[v32].write(v39);
          }
        }
      }
