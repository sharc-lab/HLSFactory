...
void node1(
  ...
  loop2: for (int v10 = 0; v10 < 220; v10++) {
    loop3: for (int v11 = 0; v11 < 200; v11++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      float v12 = v5.read();
...
void node2(
  ...
  float v22[200][220];
  loop4: for (int v23 = 0; v23 < 240; v23++) {
    loop5: for (int v24 = 0; v24 < 220; v24++) {
      loop6: for (int v25 = 0; v25 < 200; v25++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        float v26 = v18[v25][v23];
        float v27 = v19[v23][v24];
        if (v23 == 0) {
          v22[v25][v24] = v21;
        }
        float v28 = v22[v25][v24];
        float v29 = v26 * v27;
        float v30 = v28 + v29;
        v22[v25][v24] = v30;
        if ((v23 - 239) == 0) {
          float v31 = v22[v25][v24];
          v20.write(v31);
        }
      }
    }
