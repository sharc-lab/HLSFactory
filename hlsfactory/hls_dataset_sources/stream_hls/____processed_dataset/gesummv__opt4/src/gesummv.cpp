    ...
    loop5: for (int v24 = 0; v24 < 25; v24++) {
      ...
      loop6: for (int v25 = 0; v25 < 10; v25++) {
        loop7: for (int v26 = 0; v26 < 10; v26++) {
          float v27 = v18[(v26 + (v24 * 10))][(v25 + (v23 * 10))];
          float v28 = v19[(v25 + (v23 * 10))];
          if ((v25 + (v23 * 10)) == 0) {
            v22[(v26 + (v24 * 10))] = v21;
          }
          float v29 = v22[(v26 + (v24 * 10))];
          float v30 = v27 * v28;
          float v31 = v29 + v30;
          v22[(v26 + (v24 * 10))] = v31;
          if (((v25 + (v23 * 10)) - 249) == 0) {
            float v32 = v22[(v26 + (v24 * 10))];
            v20[v26].write(v32);
          }
        }
      }
    ...
    loop9: for (int v39 = 0; v39 < 25; v39++) {
      ...
      loop10: for (int v40 = 0; v40 < 10; v40++) {
        loop11: for (int v41 = 0; v41 < 10; v41++) {
          float v42 = v33[(v41 + (v39 * 10))][(v40 + (v38 * 10))];
          float v43 = v34[(v40 + (v38 * 10))];
          if ((v40 + (v38 * 10)) == 0) {
            v37[(v41 + (v39 * 10))] = v36;
          }
          float v44 = v37[(v41 + (v39 * 10))];
          float v45 = v42 * v43;
          float v46 = v44 + v45;
          v37[(v41 + (v39 * 10))] = v46;
          if (((v40 + (v38 * 10)) - 249) == 0) {
            float v47 = v37[(v41 + (v39 * 10))];
            v35[v41].write(v47);
          }
        }
      }
