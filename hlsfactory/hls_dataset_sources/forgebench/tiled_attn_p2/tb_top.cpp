...
data_t DRAM_weights_q[64][256];
data_t DRAM_weights_k[64][256];
data_t DRAM_weights_v[64][256];
...
int main() {
    ...
    load_txt_to_array("DRAM_weights_q.txt", (data_t*)DRAM_weights_q, 16384);
    load_txt_to_array("DRAM_weights_k.txt", (data_t*)DRAM_weights_k, 16384);
    load_txt_to_array("DRAM_weights_v.txt", (data_t*)DRAM_weights_v, 16384);
