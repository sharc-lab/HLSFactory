...
data_t DRAM_image_input[128][7][7];
data_t DRAM_conv_weight[128][128][3][3];
data_t DRAM_conv_bias[128];
data_t DRAM_image_output[128][7][7];
...
int main() {
    load_txt_to_array("DRAM_image_input.txt", (data_t*)DRAM_image_input, 6272);
    ...
    load_txt_to_array("DRAM_image_output.txt", (data_t*)DRAM_image_output, 6272);
