...
data_t DRAM_1[32][128];
data_t DRAM_2[128][32];
data_t DRAM_3[32][32];
data_t DRAM_4[32][32];
...
int main() {
    load_txt_to_array("DRAM_1.txt", (data_t*)DRAM_1, 4096);
    load_txt_to_array("DRAM_2.txt", (data_t*)DRAM_2, 4096);
    load_txt_to_array("DRAM_3.txt", (data_t*)DRAM_3, 1024);
    load_txt_to_array("DRAM_4.txt", (data_t*)DRAM_4, 1024);
