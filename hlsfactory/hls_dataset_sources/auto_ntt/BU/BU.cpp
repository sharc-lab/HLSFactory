...
#pragma HLS disaggregate variable = fwd_inVal0
#pragma HLS interface ap_fifo port = fwd_inVal0._
#pragma HLS aggregate variable = fwd_inVal0._ bit
#pragma HLS interface ap_fifo port = fwd_inVal0._peek
#pragma HLS aggregate variable = fwd_inVal0._peek bit
void(fwd_inVal0._.empty());
void(fwd_inVal0._peek.empty());

#pragma HLS disaggregate variable = fwd_inVal1
#pragma HLS interface ap_fifo port = fwd_inVal1._
#pragma HLS aggregate variable = fwd_inVal1._ bit
#pragma HLS interface ap_fifo port = fwd_inVal1._peek
#pragma HLS aggregate variable = fwd_inVal1._peek bit
void(fwd_inVal1._.empty());
void(fwd_inVal1._peek.empty());

#pragma HLS disaggregate variable = inv_inVal0
#pragma HLS interface ap_fifo port = inv_inVal0._
#pragma HLS aggregate variable = inv_inVal0._ bit
#pragma HLS interface ap_fifo port = inv_inVal0._peek
#pragma HLS aggregate variable = inv_inVal0._peek bit
void(inv_inVal0._.empty());
void(inv_inVal0._peek.empty());

#pragma HLS disaggregate variable = inv_inVal1
#pragma HLS interface ap_fifo port = inv_inVal1._
#pragma HLS aggregate variable = inv_inVal1._ bit
#pragma HLS interface ap_fifo port = inv_inVal1._peek
#pragma HLS aggregate variable = inv_inVal1._peek bit
void(inv_inVal1._.empty());
void(inv_inVal1._peek.empty());

#pragma HLS disaggregate variable = tf_inVal
#pragma HLS interface ap_fifo port = tf_inVal._
#pragma HLS aggregate variable = tf_inVal._ bit
#pragma HLS interface ap_fifo port = tf_inVal._peek
#pragma HLS aggregate variable = tf_inVal._peek bit
void(tf_inVal._.empty());
void(tf_inVal._peek.empty());

#pragma HLS disaggregate variable = fwd_outVal0
#pragma HLS interface ap_fifo port = fwd_outVal0._
#pragma HLS aggregate variable = fwd_outVal0._ bit
void(fwd_outVal0._.full());

#pragma HLS disaggregate variable = fwd_outVal1
#pragma HLS interface ap_fifo port = fwd_outVal1._
#pragma HLS aggregate variable = fwd_outVal1._ bit
void(fwd_outVal1._.full());

#pragma HLS disaggregate variable = inv_outVal0
#pragma HLS interface ap_fifo port = inv_outVal0._
#pragma HLS aggregate variable = inv_outVal0._ bit
void(inv_outVal0._.full());

#pragma HLS disaggregate variable = inv_outVal1
#pragma HLS interface ap_fifo port = inv_outVal1._
#pragma HLS aggregate variable = inv_outVal1._ bit
void(inv_outVal1._.full());
