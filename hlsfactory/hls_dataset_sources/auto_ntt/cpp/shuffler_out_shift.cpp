...
#pragma HLS disaggregate variable = inv_inVal_inter_0
#pragma HLS array_partition variable = inv_inVal_inter_0 complete
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[0]._
#pragma HLS aggregate variable = inv_inVal_inter_0[0]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[0]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[0]._peek bit
void(inv_inVal_inter_0[0]._.empty());
void(inv_inVal_inter_0[0]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[1]._
#pragma HLS aggregate variable = inv_inVal_inter_0[1]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[1]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[1]._peek bit
void(inv_inVal_inter_0[1]._.empty());
void(inv_inVal_inter_0[1]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[2]._
#pragma HLS aggregate variable = inv_inVal_inter_0[2]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[2]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[2]._peek bit
void(inv_inVal_inter_0[2]._.empty());
void(inv_inVal_inter_0[2]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[3]._
#pragma HLS aggregate variable = inv_inVal_inter_0[3]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[3]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[3]._peek bit
void(inv_inVal_inter_0[3]._.empty());
void(inv_inVal_inter_0[3]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[4]._
#pragma HLS aggregate variable = inv_inVal_inter_0[4]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[4]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[4]._peek bit
void(inv_inVal_inter_0[4]._.empty());
void(inv_inVal_inter_0[4]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[5]._
#pragma HLS aggregate variable = inv_inVal_inter_0[5]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[5]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[5]._peek bit
void(inv_inVal_inter_0[5]._.empty());
void(inv_inVal_inter_0[5]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[6]._
#pragma HLS aggregate variable = inv_inVal_inter_0[6]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[6]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[6]._peek bit
void(inv_inVal_inter_0[6]._.empty());
void(inv_inVal_inter_0[6]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[7]._
#pragma HLS aggregate variable = inv_inVal_inter_0[7]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[7]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[7]._peek bit
void(inv_inVal_inter_0[7]._.empty());
void(inv_inVal_inter_0[7]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[8]._
#pragma HLS aggregate variable = inv_inVal_inter_0[8]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[8]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[8]._peek bit
void(inv_inVal_inter_0[8]._.empty());
void(inv_inVal_inter_0[8]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[9]._
#pragma HLS aggregate variable = inv_inVal_inter_0[9]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[9]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[9]._peek bit
void(inv_inVal_inter_0[9]._.empty());
void(inv_inVal_inter_0[9]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[10]._
#pragma HLS aggregate variable = inv_inVal_inter_0[10]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[10]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[10]._peek bit
void(inv_inVal_inter_0[10]._.empty());
void(inv_inVal_inter_0[10]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[11]._
#pragma HLS aggregate variable = inv_inVal_inter_0[11]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[11]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[11]._peek bit
void(inv_inVal_inter_0[11]._.empty());
void(inv_inVal_inter_0[11]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[12]._
#pragma HLS aggregate variable = inv_inVal_inter_0[12]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[12]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[12]._peek bit
void(inv_inVal_inter_0[12]._.empty());
void(inv_inVal_inter_0[12]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[13]._
#pragma HLS aggregate variable = inv_inVal_inter_0[13]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[13]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[13]._peek bit
void(inv_inVal_inter_0[13]._.empty());
void(inv_inVal_inter_0[13]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[14]._
#pragma HLS aggregate variable = inv_inVal_inter_0[14]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[14]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[14]._peek bit
void(inv_inVal_inter_0[14]._.empty());
void(inv_inVal_inter_0[14]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[15]._
#pragma HLS aggregate variable = inv_inVal_inter_0[15]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_inter_0[15]._peek
#pragma HLS aggregate variable = inv_inVal_inter_0[15]._peek bit
void(inv_inVal_inter_0[15]._.empty());
void(inv_inVal_inter_0[15]._peek.empty());

#pragma HLS disaggregate variable = inv_inVal_intra
#pragma HLS array_partition variable = inv_inVal_intra complete
#pragma HLS interface ap_fifo port = inv_inVal_intra[0]._
#pragma HLS aggregate variable = inv_inVal_intra[0]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[0]._peek
#pragma HLS aggregate variable = inv_inVal_intra[0]._peek bit
void(inv_inVal_intra[0]._.empty());
void(inv_inVal_intra[0]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[1]._
#pragma HLS aggregate variable = inv_inVal_intra[1]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[1]._peek
#pragma HLS aggregate variable = inv_inVal_intra[1]._peek bit
void(inv_inVal_intra[1]._.empty());
void(inv_inVal_intra[1]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[2]._
#pragma HLS aggregate variable = inv_inVal_intra[2]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[2]._peek
#pragma HLS aggregate variable = inv_inVal_intra[2]._peek bit
void(inv_inVal_intra[2]._.empty());
void(inv_inVal_intra[2]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[3]._
#pragma HLS aggregate variable = inv_inVal_intra[3]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[3]._peek
#pragma HLS aggregate variable = inv_inVal_intra[3]._peek bit
void(inv_inVal_intra[3]._.empty());
void(inv_inVal_intra[3]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[4]._
#pragma HLS aggregate variable = inv_inVal_intra[4]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[4]._peek
#pragma HLS aggregate variable = inv_inVal_intra[4]._peek bit
void(inv_inVal_intra[4]._.empty());
void(inv_inVal_intra[4]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[5]._
#pragma HLS aggregate variable = inv_inVal_intra[5]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[5]._peek
#pragma HLS aggregate variable = inv_inVal_intra[5]._peek bit
void(inv_inVal_intra[5]._.empty());
void(inv_inVal_intra[5]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[6]._
#pragma HLS aggregate variable = inv_inVal_intra[6]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[6]._peek
#pragma HLS aggregate variable = inv_inVal_intra[6]._peek bit
void(inv_inVal_intra[6]._.empty());
void(inv_inVal_intra[6]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[7]._
#pragma HLS aggregate variable = inv_inVal_intra[7]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[7]._peek
#pragma HLS aggregate variable = inv_inVal_intra[7]._peek bit
void(inv_inVal_intra[7]._.empty());
void(inv_inVal_intra[7]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[8]._
#pragma HLS aggregate variable = inv_inVal_intra[8]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[8]._peek
#pragma HLS aggregate variable = inv_inVal_intra[8]._peek bit
void(inv_inVal_intra[8]._.empty());
void(inv_inVal_intra[8]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[9]._
#pragma HLS aggregate variable = inv_inVal_intra[9]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[9]._peek
#pragma HLS aggregate variable = inv_inVal_intra[9]._peek bit
void(inv_inVal_intra[9]._.empty());
void(inv_inVal_intra[9]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[10]._
#pragma HLS aggregate variable = inv_inVal_intra[10]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[10]._peek
#pragma HLS aggregate variable = inv_inVal_intra[10]._peek bit
void(inv_inVal_intra[10]._.empty());
void(inv_inVal_intra[10]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[11]._
#pragma HLS aggregate variable = inv_inVal_intra[11]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[11]._peek
#pragma HLS aggregate variable = inv_inVal_intra[11]._peek bit
void(inv_inVal_intra[11]._.empty());
void(inv_inVal_intra[11]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[12]._
#pragma HLS aggregate variable = inv_inVal_intra[12]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[12]._peek
#pragma HLS aggregate variable = inv_inVal_intra[12]._peek bit
void(inv_inVal_intra[12]._.empty());
void(inv_inVal_intra[12]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[13]._
#pragma HLS aggregate variable = inv_inVal_intra[13]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[13]._peek
#pragma HLS aggregate variable = inv_inVal_intra[13]._peek bit
void(inv_inVal_intra[13]._.empty());
void(inv_inVal_intra[13]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[14]._
#pragma HLS aggregate variable = inv_inVal_intra[14]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[14]._peek
#pragma HLS aggregate variable = inv_inVal_intra[14]._peek bit
void(inv_inVal_intra[14]._.empty());
void(inv_inVal_intra[14]._peek.empty());
#pragma HLS interface ap_fifo port = inv_inVal_intra[15]._
#pragma HLS aggregate variable = inv_inVal_intra[15]._ bit
#pragma HLS interface ap_fifo port = inv_inVal_intra[15]._peek
#pragma HLS aggregate variable = inv_inVal_intra[15]._peek bit
void(inv_inVal_intra[15]._.empty());
void(inv_inVal_intra[15]._peek.empty());

#pragma HLS disaggregate variable = fwd_outVal_inter_0
#pragma HLS array_partition variable = fwd_outVal_inter_0 complete
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[0]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[0]._ bit
void(fwd_outVal_inter_0[0]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[1]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[1]._ bit
void(fwd_outVal_inter_0[1]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[2]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[2]._ bit
void(fwd_outVal_inter_0[2]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[3]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[3]._ bit
void(fwd_outVal_inter_0[3]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[4]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[4]._ bit
void(fwd_outVal_inter_0[4]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[5]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[5]._ bit
void(fwd_outVal_inter_0[5]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[6]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[6]._ bit
void(fwd_outVal_inter_0[6]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[7]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[7]._ bit
void(fwd_outVal_inter_0[7]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[8]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[8]._ bit
void(fwd_outVal_inter_0[8]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[9]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[9]._ bit
void(fwd_outVal_inter_0[9]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[10]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[10]._ bit
void(fwd_outVal_inter_0[10]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[11]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[11]._ bit
void(fwd_outVal_inter_0[11]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[12]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[12]._ bit
void(fwd_outVal_inter_0[12]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[13]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[13]._ bit
void(fwd_outVal_inter_0[13]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[14]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[14]._ bit
void(fwd_outVal_inter_0[14]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_inter_0[15]._
#pragma HLS aggregate variable = fwd_outVal_inter_0[15]._ bit
void(fwd_outVal_inter_0[15]._.full());

#pragma HLS disaggregate variable = fwd_outVal_intra
#pragma HLS array_partition variable = fwd_outVal_intra complete
#pragma HLS interface ap_fifo port = fwd_outVal_intra[0]._
#pragma HLS aggregate variable = fwd_outVal_intra[0]._ bit
void(fwd_outVal_intra[0]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[1]._
#pragma HLS aggregate variable = fwd_outVal_intra[1]._ bit
void(fwd_outVal_intra[1]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[2]._
#pragma HLS aggregate variable = fwd_outVal_intra[2]._ bit
void(fwd_outVal_intra[2]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[3]._
#pragma HLS aggregate variable = fwd_outVal_intra[3]._ bit
void(fwd_outVal_intra[3]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[4]._
#pragma HLS aggregate variable = fwd_outVal_intra[4]._ bit
void(fwd_outVal_intra[4]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[5]._
#pragma HLS aggregate variable = fwd_outVal_intra[5]._ bit
void(fwd_outVal_intra[5]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[6]._
#pragma HLS aggregate variable = fwd_outVal_intra[6]._ bit
void(fwd_outVal_intra[6]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[7]._
#pragma HLS aggregate variable = fwd_outVal_intra[7]._ bit
void(fwd_outVal_intra[7]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[8]._
#pragma HLS aggregate variable = fwd_outVal_intra[8]._ bit
void(fwd_outVal_intra[8]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[9]._
#pragma HLS aggregate variable = fwd_outVal_intra[9]._ bit
void(fwd_outVal_intra[9]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[10]._
#pragma HLS aggregate variable = fwd_outVal_intra[10]._ bit
void(fwd_outVal_intra[10]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[11]._
#pragma HLS aggregate variable = fwd_outVal_intra[11]._ bit
void(fwd_outVal_intra[11]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[12]._
#pragma HLS aggregate variable = fwd_outVal_intra[12]._ bit
void(fwd_outVal_intra[12]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[13]._
#pragma HLS aggregate variable = fwd_outVal_intra[13]._ bit
void(fwd_outVal_intra[13]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[14]._
#pragma HLS aggregate variable = fwd_outVal_intra[14]._ bit
void(fwd_outVal_intra[14]._.full());
#pragma HLS interface ap_fifo port = fwd_outVal_intra[15]._
#pragma HLS aggregate variable = fwd_outVal_intra[15]._ bit
void(fwd_outVal_intra[15]._.full());
...
void(inv_outVal[15]._.full());
  ...
  VAR_TYPE_8 shift_counts_table[shuffleLimit] = {2, 0};
  ...
  for(VAR_TYPE_16 iterCount=0; iterCount<(iter+1); iterCount++){
    for(VAR_TYPE_8 shuffler_id=0, inv_shuffler_id=shuffleLimit-1; shuffler_id<shuffleLimit; shuffler_id++, inv_shuffler_id--){
      OUT_SHUF_COMP:for(VAR_TYPE_16 i=0; i<dataCount;){
        ...
        VAR_TYPE_8 shift_counts = shift_counts_table[comp_shuffler_id];
        ...
        if(inpStreamNotEmpty){
          ...
          //shuffle amount gen
          shift_amount = ( ( i & ( (1<<(log_shift_freq-log_mini_shift_reset_freq)) - 1 ) ) == 0) ? ( ( max_data_offset - (((i >> (log_shift_freq-log_mini_shift_reset_freq)) << (shift_counts + log_mini_shift_amount)) % (max_data_offset)) ) % (max_data_offset) ) : (shift_amount);

          if(direction){
            adjusted_shift_amount = shift_amount;
          }
          else{
            adjusted_shift_amount = ( max_data_offset - shift_amount ) % max_data_offset;
          }

          //shuffle
          for(VAR_TYPE_8 j=0; j<2*V_BUG_SIZE; j++){
            #pragma HLS UNROLL
            outValRegArr[(j+adjusted_shift_amount)%max_data_offset] = inValRegArr[j];
          }
