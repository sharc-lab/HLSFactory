...
void Mmap2Stream_tf_0_1_limbs(tapa::async_mmap<TF_WIDE_DATA>& tf_mmap,
                 ...
                 bool direction,
                 VAR_TYPE_16 iter) {
#pragma HLS disaggregate variable = tf_mmap
#pragma HLS interface ap_fifo port = tf_mmap.read_addr._
#pragma HLS aggregate variable = tf_mmap.read_addr._  bit
#pragma HLS interface ap_fifo port = tf_mmap.read_data._
#pragma HLS aggregate variable = tf_mmap.read_data._  bit
#pragma HLS interface ap_fifo port = tf_mmap.write_addr._
#pragma HLS aggregate variable = tf_mmap.write_addr._  bit
#pragma HLS interface ap_fifo port = tf_mmap.write_data._
#pragma HLS aggregate variable = tf_mmap.write_data._  bit
#pragma HLS interface ap_fifo port = tf_mmap.write_resp._
#pragma HLS aggregate variable = tf_mmap.write_resp._  bit
#pragma HLS disaggregate variable = tf_mmap .read_data
#pragma HLS interface ap_fifo port = tf_mmap.read_data._peek
#pragma HLS aggregate variable = tf_mmap.read_data._peek bit
#pragma HLS disaggregate variable = tf_mmap .write_resp
#pragma HLS interface ap_fifo port = tf_mmap.write_resp._peek
#pragma HLS aggregate variable = tf_mmap.write_resp._peek bit
void(tf_mmap.read_addr._.full());
void(tf_mmap.read_data._.empty());
void(tf_mmap.read_data._peek.empty());
void(tf_mmap.write_addr._.full());
void(tf_mmap.write_data._.full());
void(tf_mmap.write_resp._.empty());
void(tf_mmap.write_resp._peek.empty());

#pragma HLS disaggregate variable = tf_stream_L0_0
#pragma HLS array_partition variable = tf_stream_L0_0 complete
#pragma HLS interface ap_fifo port = tf_stream_L0_0[0]._
#pragma HLS aggregate variable = tf_stream_L0_0[0]._ bit
void(tf_stream_L0_0[0]._.full());
#pragma HLS interface ap_fifo port = tf_stream_L0_0[1]._
#pragma HLS aggregate variable = tf_stream_L0_0[1]._ bit
void(tf_stream_L0_0[1]._.full());
#pragma HLS interface ap_fifo port = tf_stream_L0_0[2]._
#pragma HLS aggregate variable = tf_stream_L0_0[2]._ bit
void(tf_stream_L0_0[2]._.full());
#pragma HLS interface ap_fifo port = tf_stream_L0_0[3]._
#pragma HLS aggregate variable = tf_stream_L0_0[3]._ bit
void(tf_stream_L0_0[3]._.full());
#pragma HLS interface ap_fifo port = tf_stream_L0_0[4]._
#pragma HLS aggregate variable = tf_stream_L0_0[4]._ bit
void(tf_stream_L0_0[4]._.full());
#pragma HLS interface ap_fifo port = tf_stream_L0_0[5]._
#pragma HLS aggregate variable = tf_stream_L0_0[5]._ bit
void(tf_stream_L0_0[5]._.full());
#pragma HLS interface ap_fifo port = tf_stream_L0_0[6]._
#pragma HLS aggregate variable = tf_stream_L0_0[6]._ bit
void(tf_stream_L0_0[6]._.full());
#pragma HLS interface ap_fifo port = tf_stream_L0_0[7]._
#pragma HLS aggregate variable = tf_stream_L0_0[7]._ bit
void(tf_stream_L0_0[7]._.full());




  
  VAR_TYPE_16 fwd_total_depth = 242;
  VAR_TYPE_16 inv_total_depth = 204;
