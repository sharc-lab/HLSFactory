...
#pragma HLS interface s_axilite port = polyVectorInOut_G0 bundle = control
{ auto val = reinterpret_cast<volatile uint8_t&>(polyVectorInOut_G0); }
{ auto val = reinterpret_cast<volatile uint8_t&>(polyVectorInOut_G0); }

#pragma HLS interface s_axilite port = TFArr_G0 bundle = control
{ auto val = reinterpret_cast<volatile uint8_t&>(TFArr_G0); }
{ auto val = reinterpret_cast<volatile uint8_t&>(TFArr_G0); }

#pragma HLS interface s_axilite port = TFArr_G1 bundle = control
{ auto val = reinterpret_cast<volatile uint8_t&>(TFArr_G1); }
{ auto val = reinterpret_cast<volatile uint8_t&>(TFArr_G1); }

#pragma HLS interface s_axilite port = polyVectorInOut_G1 bundle = control
{ auto val = reinterpret_cast<volatile uint8_t&>(polyVectorInOut_G1); }
{ auto val = reinterpret_cast<volatile uint8_t&>(polyVectorInOut_G1); }

#pragma HLS interface s_axilite port = q0 bundle = control
{ auto val = reinterpret_cast<volatile uint8_t&>(q0); }

#pragma HLS interface s_axilite port = twoInverse0 bundle = control
{ auto val = reinterpret_cast<volatile uint8_t&>(twoInverse0); }

#pragma HLS interface s_axilite port = factor0 bundle = control
{ auto val = reinterpret_cast<volatile uint8_t&>(factor0); }

#pragma HLS interface s_axilite port = direction bundle = control
{ auto val = reinterpret_cast<volatile uint8_t&>(direction); }

#pragma HLS interface s_axilite port = iter bundle = control
{ auto val = reinterpret_cast<volatile uint8_t&>(iter); }
