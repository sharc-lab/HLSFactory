...
#pragma HLS interface ap_fifo port = fwd_inVal._
#pragma HLS aggregate variable = fwd_inVal._ bit
#pragma HLS interface ap_fifo port = fwd_inVal._peek
#pragma HLS aggregate variable = fwd_inVal._peek bit
void(fwd_inVal._.empty());
void(fwd_inVal._peek.empty());

#pragma HLS disaggregate variable = inv_inVal
#pragma HLS interface ap_fifo port = inv_inVal._
#pragma HLS aggregate variable = inv_inVal._ bit
#pragma HLS interface ap_fifo port = inv_inVal._peek
#pragma HLS aggregate variable = inv_inVal._peek bit
void(inv_inVal._.empty());
void(inv_inVal._peek.empty());

#pragma HLS disaggregate variable = common_outVal
#pragma HLS interface ap_fifo port = common_outVal._
#pragma HLS aggregate variable = common_outVal._ bit
void(common_outVal._.full());
