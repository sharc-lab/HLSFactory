...
{
    // Input Feature Map
    ifstream ifs_conv_input("bin/inputs/input.bin", ios::in | ios::binary);
    ...
    // Weights and biases
    read_conv_weight <32,3,3,3>  ("bin/weights/fused_features_0_conv0_bn0_weights.bin", conv_layer_weights_0, fixp_conv_layer_weights_0);
    read_conv_bias   <32>        ("bin/weights/fused_features_0_conv0_bn0_bias.bin", conv_layer_bias_0, fixp_conv_layer_bias_0);

    read_conv_weight <32,1,3,3>  ("bin/weights/fused_features_1_conv_0_conv0_bn0_weights.bin", conv_layer_weights_1_0, fixp_conv_layer_weights_1_0);
    read_conv_bias   <32>        ("bin/weights/fused_features_1_conv_0_conv0_bn0_bias.bin", conv_layer_bias_1_0, fixp_conv_layer_bias_1_0);
    read_conv_weight <16,32,1,1> ("bin/weights/fused_features_1_conv_conv1_bn1_weights.bin", conv_layer_weights_1_1, fixp_conv_layer_weights_1_1);
    read_conv_bias   <16>        ("bin/weights/fused_features_1_conv_conv1_bn1_bias.bin", conv_layer_bias_1_1, fixp_conv_layer_bias_1_1);

    read_conv_weight <96,16,1,1> ("bin/weights/fused_features_2_conv_0_conv0_bn0_weights.bin", conv_layer_weights_2_0, fixp_conv_layer_weights_2_0);
    read_conv_bias   <96>        ("bin/weights/fused_features_2_conv_0_conv0_bn0_bias.bin", conv_layer_bias_2_0, fixp_conv_layer_bias_2_0);
    read_conv_weight <1,96,3,3> ("bin/weights/fused_features_2_conv_1_conv0_bn0_weights.bin", conv_layer_weights_2_1, fixp_conv_layer_weights_2_1);
    read_conv_bias   <96>        ("bin/weights/fused_features_2_conv_1_conv0_bn0_bias.bin", conv_layer_bias_2_1, fixp_conv_layer_bias_2_1);
    read_conv_weight <24,96,1,1> ("bin/weights/fused_features_2_conv_conv2_bn2_weights.bin", conv_layer_weights_2_2, fixp_conv_layer_weights_2_2);
    read_conv_bias   <24>        ("bin/weights/fused_features_2_conv_conv2_bn2_bias.bin", conv_layer_bias_2_2, fixp_conv_layer_bias_2_2);


    // Golden Output
    ifstream ifs_golden_output("bin/outputs/features_2_conv_3.bin", ios::in | ios::binary);
...
int main ()
{
    ...
    for(int f = 0; f < 24; f++)
    {
        ...
        //}
        //#ifdef PRINT_DEBUG
        if ((conv_layer_golden_output_feature_map[f][i][j] - (float) fixp_conv_layer_output_feature_map[f][i][j]) > 0.01) {
