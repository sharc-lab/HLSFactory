#line 18 "soda_designs_processed/soda__jacobi3d/jacobi3d_host.cpp"
#include <cassert>
#include <cfloat>
#include <cmath>
#include <cstdbool>
  ...
  const int unroll_factor = 2)
{
  ...
  int bank_count_t1 = 1;
  int bank_count_t0 = 1;
#line 105 "soda_designs_processed/soda__jacobi3d/jacobi3d_host.cpp"
  ...
  ::jacobi3d_kernel(
    ...
    cycle_count);
#line 221 "soda_designs_processed/soda__jacobi3d/jacobi3d_host.cpp"
  for(int32_t tile_index_dim_1 = 0; tile_index_dim_1 < tile_count_dim_1; ++tile_index_dim_1)
  {
    int32_t actual_tile_size_dim_1 = (tile_index_dim_1 == tile_count_dim_1-1) ? var_t1_extent[1] - (tile_size_1 - kStencilDim1 + 1) * tile_index_dim_1 : tile_size_1;
    for(int32_t tile_index_dim_0 = 0; tile_index_dim_0 < tile_count_dim_0; ++tile_index_dim_0)
    {
      ...
      for(int32_t k = 2; k < var_t0_extent[2] - 2; ++k)
      {
        for(int32_t j = 2; j < actual_tile_size_dim_1 - 2; ++j)
        {
          for(int32_t i = 2; i < actual_tile_size_dim_0 - 2; ++i)
          {
            ...
            int32_t burst_index_t0 = (i + j * tile_size_0 + k * tile_size_0 * tile_size_1 + 2048) / elem_count_per_cycle_t0;
            int32_t burst_residue_t0 = (i + j * tile_size_0 + k * tile_size_0 * tile_size_1 + 2048) % elem_count_per_cycle_t0;
...
}ssed/soda__jacobi3d/jacobi3d_host.cpp"
#include <cassert>
#include <cfloat>
#include <cmath>
#include <cstdbool>
