...
void node1(
  ...
  loop4: for (int v12 = 0; v12 < 20; v12++) {
    loop5: for (int v13 = 0; v13 < 50; v13++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
...
void node2(
  ...
  loop8: for (int v27 = 0; v27 < 24; v27++) {
    loop9: for (int v28 = 0; v28 < 20; v28++) {
      loop10: for (int v29 = 0; v29 < 50; v29++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        loop11: for (int v30 = 0; v30 < 10; v30++) {
          loop12: for (int v31 = 0; v31 < 11; v31++) {
            loop13: for (int v32 = 0; v32 < 4; v32++) {
              float v33 = v22[(v32 + (v29 * 4))][(v30 + (v27 * 10))];
              float v34 = v23[(v30 + (v27 * 10))][(v31 + (v28 * 11))];
              if ((v30 + (v27 * 10)) == 0) {
                v26[(v32 + (v29 * 4))][(v31 + (v28 * 11))] = v25;
              }
              float v35 = v26[(v32 + (v29 * 4))][(v31 + (v28 * 11))];
              float v36 = v33 * v34;
              float v37 = v35 + v36;
              v26[(v32 + (v29 * 4))][(v31 + (v28 * 11))] = v37;
              if (((v30 + (v27 * 10)) - 239) == 0) {
                float v38 = v26[(v32 + (v29 * 4))][(v31 + (v28 * 11))];
