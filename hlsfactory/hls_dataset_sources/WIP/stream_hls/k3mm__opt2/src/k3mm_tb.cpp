...
void forward(float[180][200], float[200][190], float[190][220], float[220][210],
             float[180][210]);
int32_t main(int argc, char **argv) {
  ...
  float v1[200][190];
  std::ifstream input_1ifs(prj_path_str + "/data/input_1.bin",
                           std::ios::binary);
  ...
  float v2[190][220];
  std::ifstream input_2ifs(prj_path_str + "/data/input_2.bin",
                           std::ios::binary);
  ...
  float v3[220][210];
  std::ifstream input_3ifs(prj_path_str + "/data/input_3.bin",
                           std::ios::binary);
  ...
  bool v5 = {1};
  float v6[180][210];
  std::ifstream output_0ifs(prj_path_str + "/data/output_0.bin",
                            std::ios::binary);
...
loop0:
  for (int v7 = 0; v7 < 180; v7++) {
  loop1:
    for (int v8 = 0; v8 < 210; v8++) {
      float v9 = v4[v7][v8];
      float v10 = v6[v7][v8];
      float v11 = v9 - v10;
      float v12 = v10 - v9;
