...
void node1(
  ...
  loop2: for (int v8 = 0; v8 < 128; v8++) {
    loop3: for (int v9 = 0; v9 < 64; v9++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      float v10 = v5.read();
      float v11 = v6[v8];
...
void node2(
  ...
  float v18[128][128];
  float v19[64][128];
  loop4: for (int v20 = 0; v20 < 128; v20++) {
    loop5: for (int v21 = 0; v21 < 128; v21++) {
      loop6: for (int v22 = 0; v22 < 64; v22++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        if (v20 == 0) {
          float v23 = v13.read();
        ...
        float v24 = v19[v22][v21];
        if (v22 == 0) {
          float v25 = v14[v21][v20];
          v18[v21][v20] = v25;
        }
        float v26 = v18[v21][v20];
        if (v21 == 0) {
          v17[v22][v20] = v16;
        }
        float v27 = v17[v22][v20];
        float v28 = v24 * v26;
        float v29 = v27 + v28;
        v17[v22][v20] = v29;
        if ((v21 - 127) == 0) {
          float v30 = v17[v22][v20];
          v15.write(v30);
        }
      }
    }
...
void node4(
  ...
  loop9: for (int v38 = 0; v38 < 128; v38++) {
    loop10: for (int v39 = 0; v39 < 64; v39++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      float v40 = v36[v39][(v38 / 16)][(v38 % 16)];
      v37.write(v40);
    }
  }
  return ;
...
void node6(
  ...
  loop14: for (int v54 = 0; v54 < 8; v54++) {
    loop15: for (int v55 = 0; v55 < 64; v55++) {
      loop16: for (int v56 = 0; v56 < 64; v56++) {
        loop17: for (int v57 = 0; v57 < 16; v57++) {
          ...
          float v59 = v53[v54][v55][v56];
          if (v55 == 0) {
            float v60 = v48[v54][v56][v57];
            v52[v54][v56][v57] = v60;
          }
          float v61 = v52[v54][v56][v57];
          if (v56 == 0) {
            v51[v54][v55][v57] = v50;
          }
          float v62 = v51[v54][v55][v57];
          float v63 = v59 * v61;
          float v64 = v62 + v63;
          v51[v54][v55][v57] = v64;
          if ((v56 - 63) == 0) {
            float v65 = v51[v54][v55][v57];
            v49[v54][v55][v57] = v65;
          }
        }
      }
...
void node7(
  ...
  loop18: for (int v68 = 0; v68 < 8; v68++) {
    loop19: for (int v69 = 0; v69 < 16; v69++) {
      loop20: for (int v70 = 0; v70 < 64; v70++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        float v71 = v66[v70][((v68 * 16) + v69)];
        v67[v68][v70][v69] = v71;
      }
    }
  }
...
void node13(
  ...
  loop36: for (int v134 = 0; v134 < 8; v134++) {
    loop37: for (int v135 = 0; v135 < 16; v135++) {
      loop38: for (int v136 = 0; v136 < 64; v136++) {
        loop39: for (int v137 = 0; v137 < 64; v137++) {
          #pragma HLS pipeline II=1
          #pragma HLS loop_flatten
          if (v137 == 0) {
            float v138 = v128.read();
            v133[v134][v136][v135] = v138;
          }
          float v139 = v133[v134][v136][v135];
          if (v136 == 0) {
            float v140 = v127.read();
            v132[v134][v135][v137] = v140;
          }
          float v141 = v132[v134][v135][v137];
          if (v135 == 0) {
            v131[v134][v136][v137] = v130;
          }
          float v142 = v131[v134][v136][v137];
          float v143 = v139 * v141;
          float v144 = v142 + v143;
          v131[v134][v136][v137] = v144;
          if ((v135 - 15) == 0) {
            float v145 = v131[v134][v136][v137];
            v129.write(v145);
          }
        }
      }
...
void node15(
  ...
  loop43: for (int v154 = 0; v154 < 8; v154++) {
    loop44: for (int v155 = 0; v155 < 16; v155++) {
      loop45: for (int v156 = 0; v156 < 64; v156++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        float v157 = v152[v156][((v154 * 16) + v155)];
        v153.write(v157);
      }
    }
  }
  ...
  loop48: for (int v173 = 0; v173 < 64; v173++) {
    loop49: for (int v174 = 0; v174 < 128; v174++) {
      loop50: for (int v175 = 0; v175 < 128; v175++) {
        ...
        #pragma HLS loop_flatten
        if (v175 == 0) {
          float v176 = v167.read();
          v172[v173][v174] = v176;
        }
        float v177 = v172[v173][v174];
        if (v173 == 0) {
          float v178 = v166.read();
          v171[v174][v175] = v178;
        }
        float v179 = v171[v174][v175];
        if (v174 == 0) {
          v170[v173][v175] = v169;
        }
        float v180 = v170[v173][v175];
        float v181 = v177 * v179;
        float v182 = v180 + v181;
        v170[v173][v175] = v182;
        if ((v174 - 127) == 0) {
          float v183 = v170[v173][v175];
          v168.write(v183);
        }
      }
    }
  ...
  loop55: for (int v204 = 0; v204 < 64; v204++) {
    loop56: for (int v205 = 0; v205 < 128; v205++) {
      loop57: for (int v206 = 0; v206 < 128; v206++) {
        ...
        #pragma HLS loop_flatten
        if (v206 == 0) {
          float v207 = v197.read();
          v203[v204][v205] = v207;
        }
        float v208 = v203[v204][v205];
        if (v204 == 0) {
          float v209 = v198.read();
          v202[v205][v206] = v209;
        }
        float v210 = v202[v205][v206];
        if (v205 == 0) {
          v201[v204][v206] = v200;
        }
        float v211 = v201[v204][v206];
        float v212 = v208 * v210;
        float v213 = v211 + v212;
        v201[v204][v206] = v213;
        if ((v205 - 127) == 0) {
          float v214 = v201[v204][v206];
          v199.write(v214);
        }
      }
    }
  ...
  loop62: for (int v235 = 0; v235 < 64; v235++) {
    loop63: for (int v236 = 0; v236 < 128; v236++) {
      loop64: for (int v237 = 0; v237 < 128; v237++) {
        ...
        #pragma HLS loop_flatten
        if (v237 == 0) {
          float v238 = v229.read();
          v234[v235][v236] = v238;
        }
        float v239 = v234[v235][v236];
        if (v235 == 0) {
          float v240 = v228.read();
          v233[v236][v237] = v240;
        }
        float v241 = v233[v236][v237];
        if (v236 == 0) {
          v232[v235][v237] = v231;
        }
        float v242 = v232[v235][v237];
        float v243 = v239 * v241;
        float v244 = v242 + v243;
        v232[v235][v237] = v244;
        if ((v236 - 127) == 0) {
          float v245 = v232[v235][v237];
          v230.write(v245);
        }
      }
    }
...
void forward(
  ...
  hls::stream<float> v283("fifo_11");
	#pragma HLS STREAM variable=v283 depth=8192
  hls::stream<float> v284("fifo_12");
	#pragma HLS STREAM variable=v284 depth=8192
  float v285[64][128];
  hls::stream<float> v286("fifo_13");
	#pragma HLS STREAM variable=v286 depth=8192
  hls::stream<float> v287("fifo_14");
	#pragma HLS STREAM variable=v287 depth=16384
  float v288[64][128];
  hls::stream<float> v289("fifo_15");
	#pragma HLS STREAM variable=v289 depth=8192
  hls::stream<float> v290("fifo_16");
	#pragma HLS STREAM variable=v290 depth=16384
  float v291[64][128];
  hls::stream<float> v292("fifo_17");
	#pragma HLS STREAM variable=v292 depth=8192
  hls::stream<float> v293("fifo_18");
	#pragma HLS STREAM variable=v293 depth=16384
  hls::stream<float> v294("fifo_19");
	#pragma HLS STREAM variable=v294 depth=8192
  hls::stream<float> v295("fifo_20");
	#pragma HLS STREAM variable=v295 depth=8192
  hls::stream<float> v296("fifo_21");
	#pragma HLS STREAM variable=v296 depth=8192
  node25(v258, v296, v295, v294);
  node24(v260, v293);
  node23(v293, v294, v292, 0.000000);
  node22(v292, v259, v291);
  node21(v262, v290);
  node20(v295, v290, v289, 0.000000);
  node19(v289, v261, v288);
  node18(v264, v287);
  node17(v287, v296, v286, 0.000000);
  node16(v286, v263, v285);
  node15(v291, v284);
  node14(v288, v283);
  node13(v283, v284, v282, 0.000000);
  ...
  node7(v285, v274);
  node6(v275, v274, v273, 0.000000);
  node5(v273, v272);
  node4(v272, v271);
  node3(v266, v270);
  node2(v271, v270, v269, 0.000000);
