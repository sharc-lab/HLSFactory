...
void node1(
  hls::stream<float> v7[4][8],
  hls::stream<float> v8[8][1],
  ...
  float v12[128][16];
  #pragma HLS array_partition variable=v12 cyclic dim=1 factor=8

  float v13[64][128];
  #pragma HLS array_partition variable=v13 cyclic dim=1 factor=4
  #pragma HLS array_partition variable=v13 cyclic dim=2 factor=8
  ...
  loop4: for (int v14 = 0; v14 < 16; v14++) {
    loop5: for (int v15 = 0; v15 < 16; v15++) {
      loop6: for (int v16 = 0; v16 < 16; v16++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        loop7: for (int v17 = 0; v17 < 8; v17++) {
          loop8: for (int v18 = 0; v18 < 1; v18++) {
            loop9: for (int v19 = 0; v19 < 4; v19++) {
              if ((v15 + v18) == 0) {
                float v20 = v7[v19][v17].read();
                v13[(v19 + (v16 * 4))][(v17 + (v14 * 8))] = v20;
              }
              float v21 = v13[(v19 + (v16 * 4))][(v17 + (v14 * 8))];
              if ((v19 + (v16 * 4)) == 0) {
                float v22 = v8[v17][v18].read();
                v12[(v17 + (v14 * 8))][(v15 + v18)] = v22;
              }
              float v23 = v12[(v17 + (v14 * 8))][(v15 + v18)];
              if ((v17 + (v14 * 8)) == 0) {
                v11[(v19 + (v16 * 4))][(v15 + v18)] = v10;
              }
              float v24 = v11[(v19 + (v16 * 4))][(v15 + v18)];
              float v25 = v21 * v23;
              float v26 = v24 + v25;
              v11[(v19 + (v16 * 4))][(v15 + v18)] = v26;
              if (((v17 + (v14 * 8)) - 127) == 0) {
                float v27 = v11[(v19 + (v16 * 4))][(v15 + v18)];
...
void node2(
  hls::stream<float> v28[8][4],
  hls::stream<float> v29[4][1],
  hls::stream<float> v30[8][1],
  float v31
) {
  float v32[128][16];
  #pragma HLS array_partition variable=v32 cyclic dim=1 factor=8

  float v33[64][16];
  #pragma HLS array_partition variable=v33 cyclic dim=1 factor=4

  float v34[128][64];
  #pragma HLS array_partition variable=v34 cyclic dim=1 factor=8
  ...
  loop10: for (int v35 = 0; v35 < 16; v35++) {
    loop11: for (int v36 = 0; v36 < 16; v36++) {
      loop12: for (int v37 = 0; v37 < 16; v37++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        loop13: for (int v38 = 0; v38 < 8; v38++) {
          loop14: for (int v39 = 0; v39 < 4; v39++) {
            loop15: for (int v40 = 0; v40 < 1; v40++) {
              if ((v37 + v40) == 0) {
                float v41 = v28[v38][v39].read();
                v34[(v38 + (v35 * 8))][(v39 + (v36 * 4))] = v41;
              }
              float v42 = v34[(v38 + (v35 * 8))][(v39 + (v36 * 4))];
              if ((v38 + (v35 * 8)) == 0) {
                float v43 = v29[v39][v40].read();
                v33[(v39 + (v36 * 4))][(v37 + v40)] = v43;
              }
              float v44 = v33[(v39 + (v36 * 4))][(v37 + v40)];
              if ((v39 + (v36 * 4)) == 0) {
                v32[(v38 + (v35 * 8))][(v37 + v40)] = v31;
              }
              float v45 = v32[(v38 + (v35 * 8))][(v37 + v40)];
              float v46 = v42 * v44;
              float v47 = v45 + v46;
              v32[(v38 + (v35 * 8))][(v37 + v40)] = v47;
              if (((v39 + (v36 * 4)) - 63) == 0) {
                float v48 = v32[(v38 + (v35 * 8))][(v37 + v40)];
...
void node3(
  hls::stream<float> v49[4][8],
  hls::stream<float> v50[4][4],
  hls::stream<float> v51[4][8],
  float v52
) {
  float v53[64][128];
  #pragma HLS array_partition variable=v53 cyclic dim=1 factor=4
  #pragma HLS array_partition variable=v53 cyclic dim=2 factor=8

  float v54[64][128];
  #pragma HLS array_partition variable=v54 cyclic dim=1 factor=4
  #pragma HLS array_partition variable=v54 cyclic dim=2 factor=8
  ...
  loop16: for (int v56 = 0; v56 < 16; v56++) {
    loop17: for (int v57 = 0; v57 < 16; v57++) {
      loop18: for (int v58 = 0; v58 < 16; v58++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        loop19: for (int v59 = 0; v59 < 8; v59++) {
          loop20: for (int v60 = 0; v60 < 4; v60++) {
            loop21: for (int v61 = 0; v61 < 4; v61++) {
              if ((v59 + (v56 * 8)) == 0) {
                float v62 = v50[v61][v60].read();
                v55[(v61 + (v58 * 4))][(v60 + (v57 * 4))] = v62;
              }
              float v63 = v55[(v61 + (v58 * 4))][(v60 + (v57 * 4))];
              if ((v61 + (v58 * 4)) == 0) {
                float v64 = v49[v60][v59].read();
                v54[(v60 + (v57 * 4))][(v59 + (v56 * 8))] = v64;
              }
              float v65 = v54[(v60 + (v57 * 4))][(v59 + (v56 * 8))];
              if ((v60 + (v57 * 4)) == 0) {
                v53[(v61 + (v58 * 4))][(v59 + (v56 * 8))] = v52;
              }
              float v66 = v53[(v61 + (v58 * 4))][(v59 + (v56 * 8))];
              float v67 = v63 * v65;
              float v68 = v66 + v67;
              v53[(v61 + (v58 * 4))][(v59 + (v56 * 8))] = v68;
              if (((v60 + (v57 * 4)) - 63) == 0) {
                float v69 = v53[(v61 + (v58 * 4))][(v59 + (v56 * 8))];
...
void node4(
  float v70[64][32],
  float v71[32][16],
  hls::stream<float> v72[4][1],
  float v73
) {
  #pragma HLS array_partition variable=v70 cyclic dim=1 factor=4
  #pragma HLS array_partition variable=v70 cyclic dim=2 factor=2

  #pragma HLS array_partition variable=v71 cyclic dim=1 factor=2
  ...
  loop22: for (int v75 = 0; v75 < 16; v75++) {
    loop23: for (int v76 = 0; v76 < 16; v76++) {
      loop24: for (int v77 = 0; v77 < 16; v77++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        loop25: for (int v78 = 0; v78 < 2; v78++) {
          loop26: for (int v79 = 0; v79 < 4; v79++) {
            loop27: for (int v80 = 0; v80 < 1; v80++) {
              float v81 = v70[(v79 + (v76 * 4))][(v78 + (v75 * 2))];
              float v82 = v71[(v78 + (v75 * 2))][(v77 + v80)];
              if ((v78 + (v75 * 2)) == 0) {
                v74[(v79 + (v76 * 4))][(v77 + v80)] = v73;
              }
              float v83 = v74[(v79 + (v76 * 4))][(v77 + v80)];
              float v84 = v81 * v82;
              float v85 = v83 + v84;
              v74[(v79 + (v76 * 4))][(v77 + v80)] = v85;
              if (((v78 + (v75 * 2)) - 31) == 0) {
                float v86 = v74[(v79 + (v76 * 4))][(v77 + v80)];
...
void node5(
  float v87[128][128],
  float v88[128][64],
  hls::stream<float> v89[8][4],
  float v90
) {
  #pragma HLS array_partition variable=v87 cyclic dim=1 factor=8
  ...
  float v91[128][64];
  #pragma HLS array_partition variable=v91 cyclic dim=1 factor=8
  #pragma HLS array_partition variable=v91 cyclic dim=2 factor=4

  loop28: for (int v92 = 0; v92 < 16; v92++) {
    loop29: for (int v93 = 0; v93 < 32; v93++) {
      loop30: for (int v94 = 0; v94 < 16; v94++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        loop31: for (int v95 = 0; v95 < 8; v95++) {
          loop32: for (int v96 = 0; v96 < 4; v96++) {
            loop33: for (int v97 = 0; v97 < 4; v97++) {
              float v98 = v87[(v95 + (v92 * 8))][(v96 + (v93 * 4))];
              float v99 = v88[(v96 + (v93 * 4))][(v97 + (v94 * 4))];
              if ((v96 + (v93 * 4)) == 0) {
                v91[(v95 + (v92 * 8))][(v97 + (v94 * 4))] = v90;
              }
              float v100 = v91[(v95 + (v92 * 8))][(v97 + (v94 * 4))];
              float v101 = v98 * v99;
              float v102 = v100 + v101;
              v91[(v95 + (v92 * 8))][(v97 + (v94 * 4))] = v102;
              if (((v96 + (v93 * 4)) - 127) == 0) {
                float v103 = v91[(v95 + (v92 * 8))][(v97 + (v94 * 4))];
                v89[v95][v97].write(v103);
              }
            }
          }
        }
...
void node6(
  ...
  #pragma HLS array_partition variable=v108 cyclic dim=2 factor=8
  ...
  loop34: for (int v109 = 0; v109 < 16; v109++) {
    loop35: for (int v110 = 0; v110 < 16; v110++) {
      loop36: for (int v111 = 0; v111 < 16; v111++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        loop37: for (int v112 = 0; v112 < 8; v112++) {
          loop38: for (int v113 = 0; v113 < 4; v113++) {
            loop39: for (int v114 = 0; v114 < 4; v114++) {
              float v115 = v104[(v114 + (v111 * 4))][(v113 + (v110 * 4))];
              float v116 = v105[(v113 + (v110 * 4))][(v112 + (v109 * 8))];
              if ((v113 + (v110 * 4)) == 0) {
                v108[(v114 + (v111 * 4))][(v112 + (v109 * 8))] = v107;
              }
              float v117 = v108[(v114 + (v111 * 4))][(v112 + (v109 * 8))];
              float v118 = v115 * v116;
              float v119 = v117 + v118;
              v108[(v114 + (v111 * 4))][(v112 + (v109 * 8))] = v119;
              if (((v113 + (v110 * 4)) - 63) == 0) {
                float v120 = v108[(v114 + (v111 * 4))][(v112 + (v109 * 8))];
    ...
    loop41: for (int v127 = 0; v127 < 16; v127++) {
      loop42: for (int v128 = 0; v128 < 16; v128++) {
        ...
        loop43: for (int v129 = 0; v129 < 4; v129++) {
          loop44: for (int v130 = 0; v130 < 2; v130++) {
            loop45: for (int v131 = 0; v131 < 4; v131++) {
              float v132 = v121[(v131 + (v128 * 4))][(v130 + (v127 * 2))];
              float v133 = v122[(v130 + (v127 * 2))][(v129 + (v126 * 4))];
              if ((v130 + (v127 * 2)) == 0) {
                v125[(v131 + (v128 * 4))][(v129 + (v126 * 4))] = v124;
              }
              float v134 = v125[(v131 + (v128 * 4))][(v129 + (v126 * 4))];
              float v135 = v132 * v133;
              float v136 = v134 + v135;
              v125[(v131 + (v128 * 4))][(v129 + (v126 * 4))] = v136;
              if (((v130 + (v127 * 2)) - 31) == 0) {
                float v137 = v125[(v131 + (v128 * 4))][(v129 + (v126 * 4))];
                v123[v131][v129].write(v137);
              }
            }
          }
        }
...
void forward(
  ...
  node6(v140, v141, v152, 0.000000);
  node5(v142, v143, v151, 0.000000);
  node4(v144, v145, v150, 0.000000);
  node3(v152, v153, v149, 0.000000);
  node2(v151, v150, v148, 0.000000);
