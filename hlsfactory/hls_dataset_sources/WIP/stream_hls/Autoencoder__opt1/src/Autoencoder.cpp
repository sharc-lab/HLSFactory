...
void node2(
  ...
  loop4: for (int v25 = 0; v25 < 32; v25++) {	// L35
    loop5: for (int v26 = 0; v26 < 784; v26++) {	// L36
      loop6: for (int v27 = 0; v27 < 256; v27++) {	// L37
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        if (v26 == 0) {	// L38
          float v28 = v18.read();	// L39
          v24[v25][v27] = v28;	// L40
        }
        float v29 = v24[v25][v27];	// L42
        if (v25 == 0) {	// L43
          float v30 = v19.read();	// L44
          v23[v27][v26] = v30;	// L45
        }
        float v31 = v23[v27][v26];	// L47
        if (v27 == 0) {	// L48
          v22[v25][v26] = v21;	// L49
        }
        float v32 = v22[v25][v26];	// L51
        float v33 = v29 * v31;	// L52
        float v34 = v32 + v33;	// L53
        v22[v25][v26] = v34;	// L54
        if ((v27 - 255) == 0) {	// L55
          float v35 = v22[v25][v26];	// L56
          v20.write(v35);	// L57
        }
      }
    }
...
void node6(
  ...
  loop14: for (int v72 = 0; v72 < 256; v72++) {	// L120
    loop15: for (int v73 = 0; v73 < 128; v73++) {	// L121
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      float v74 = v70[v72][v73];	// L122
      v71.write(v74);	// L123
    }
  }
  return ;	// L126
...
void node9(
  ...
  loop21: for (int v106 = 0; v106 < 128; v106++) {	// L175
    loop22: for (int v107 = 0; v107 < 64; v107++) {	// L176
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      float v108 = v104[v106][v107];	// L177
      v105.write(v108);	// L178
    }
  }
  return ;	// L181
}
...
void node12(
  ...
  loop28: for (int v137 = 0; v137 < 64; v137++) {	// L228
    loop29: for (int v138 = 0; v138 < 128; v138++) {	// L229
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      float v139 = v135[v137][v138];	// L230
      v136.write(v139);	// L231
    }
  }
  return ;	// L234
}
...
void node14(
  ...
  loop32: for (int v158 = 0; v158 < 32; v158++) {	// L253
    loop33: for (int v159 = 0; v159 < 128; v159++) {	// L254
      loop34: for (int v160 = 0; v160 < 256; v160++) {	// L255
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        if (v159 == 0) {	// L256
          float v161 = v151.read();	// L257
          v157[v158][v160] = v161;	// L258
        }
        float v162 = v157[v158][v160];	// L260
        if (v158 == 0) {	// L261
          float v163 = v152.read();	// L262
          v156[v160][v159] = v163;	// L263
        }
        float v164 = v156[v160][v159];	// L265
        if (v160 == 0) {	// L266
          v155[v158][v159] = v154;	// L267
        }
        float v165 = v155[v158][v159];	// L269
        float v166 = v162 * v164;	// L270
        float v167 = v165 + v166;	// L271
        v155[v158][v159] = v167;	// L272
        if ((v160 - 255) == 0) {	// L273
          float v168 = v155[v158][v159];	// L274
...
void node15(
  ...
  loop35: for (int v171 = 0; v171 < 128; v171++) {	// L283
    loop36: for (int v172 = 0; v172 < 256; v172++) {	// L284
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      float v173 = v169[v171][v172];	// L285
...
void node17(
  ...
  loop39: for (int v191 = 0; v191 < 32; v191++) {	// L307
    loop40: for (int v192 = 0; v192 < 256; v192++) {	// L308
      loop41: for (int v193 = 0; v193 < 784; v193++) {	// L309
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        float v194 = v185[v191][v193];	// L310
        if (v191 == 0) {	// L311
          float v195 = v186.read();	// L312
          v190[v193][v192] = v195;	// L313
        }
        float v196 = v190[v193][v192];	// L315
        if (v193 == 0) {	// L316
          v189[v191][v192] = v188;	// L317
        }
        float v197 = v189[v191][v192];	// L319
        float v198 = v194 * v196;	// L320
        float v199 = v197 + v198;	// L321
        v189[v191][v192] = v199;	// L322
        if ((v193 - 783) == 0) {	// L323
          float v200 = v189[v191][v192];	// L324
...
void node18(
  ...
  loop42: for (int v203 = 0; v203 < 256; v203++) {	// L333
    loop43: for (int v204 = 0; v204 < 784; v204++) {	// L334
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      float v205 = v201[v203][v204];	// L335
...
void forward(
  ...
  hls::stream<float> v222("fifo_2");
	#pragma HLS STREAM variable=v222 depth=200704	// L346
  hls::stream<float> v223("fifo_3");
	#pragma HLS STREAM variable=v223 depth=8192	// L347
  hls::stream<float> v224("fifo_4");
	#pragma HLS STREAM variable=v224 depth=8192	// L348
  hls::stream<float> v225("fifo_5");
	#pragma HLS STREAM variable=v225 depth=32768	// L349
  hls::stream<float> v226("fifo_6");
	#pragma HLS STREAM variable=v226 depth=4096	// L350
  hls::stream<float> v227("fifo_7");
	#pragma HLS STREAM variable=v227 depth=4096	// L351
  hls::stream<float> v228("fifo_8");
	#pragma HLS STREAM variable=v228 depth=8192	// L352
  hls::stream<float> v229("fifo_9");
	#pragma HLS STREAM variable=v229 depth=2048	// L353
  hls::stream<float> v230("fifo_10");
	#pragma HLS STREAM variable=v230 depth=2048	// L354
  hls::stream<float> v231("fifo_11");
	#pragma HLS STREAM variable=v231 depth=8192	// L355
  hls::stream<float> v232("fifo_12");
	#pragma HLS STREAM variable=v232 depth=4096	// L356
  hls::stream<float> v233("fifo_13");
	#pragma HLS STREAM variable=v233 depth=4096	// L357
  hls::stream<float> v234("fifo_14");
	#pragma HLS STREAM variable=v234 depth=32768	// L358
  hls::stream<float> v235("fifo_15");
	#pragma HLS STREAM variable=v235 depth=8192	// L359
  hls::stream<float> v236("fifo_16");
	#pragma HLS STREAM variable=v236 depth=8192	// L360
  hls::stream<float> v237("fifo_17");
  ...
  node14(v235, v234, v233, 0.000000);	// L366
  ...
  node2(v223, v222, v221, 0.000000);	// L378
