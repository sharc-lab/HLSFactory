...
void node1(
  ...
  loop2: for (int v11 = 0; v11 < 64; v11++) {
    loop3: for (int v12 = 0; v12 < 16; v12++) {
      loop4: for (int v13 = 0; v13 < 32; v13++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        if (v12 == 0) {
          float v14 = v5.read();
...
void node2(
  ...
  loop5: for (int v27 = 0; v27 < 64; v27++) {
    loop6: for (int v28 = 0; v28 < 32; v28++) {
...
void node3(
  ...
  loop8: for (int v43 = 0; v43 < 64; v43++) {
    loop9: for (int v44 = 0; v44 < 64; v44++) {
      loop10: for (int v45 = 0; v45 < 128; v45++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        if (v44 == 0) {
          float v46 = v37.read();
...
void node5(
  ...
  loop14: for (int v75 = 0; v75 < 64; v75++) {
    loop15: for (int v76 = 0; v76 < 128; v76++) {
