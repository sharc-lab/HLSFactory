...
void node1(
  ...
  loop2: for (int v11 = 0; v11 < 64; v11++) {
    loop3: for (int v12 = 0; v12 < 32; v12++) {
      loop4: for (int v13 = 0; v13 < 16; v13++) {
        ...
        float v15 = v10[v11][v12];
        float v16 = v6[v12][v13];
        if (v12 == 0) {
          v9[v11][v13] = v8;
        }
...
void node2(
  ...
  loop5: for (int v27 = 0; v27 < 64; v27++) {
    loop6: for (int v28 = 0; v28 < 64; v28++) {
      loop7: for (int v29 = 0; v29 < 32; v29++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        if (v29 == 0) {
          float v30 = v21.read();
        ...
        float v31 = v26[v27][v28];
        float v32 = v22[v28][v29];
        if (v28 == 0) {
          v25[v27][v29] = v24;
        }
        float v33 = v25[v27][v29];
        float v34 = v31 * v32;
        float v35 = v33 + v34;
        v25[v27][v29] = v35;
        if ((v28 - 63) == 0) {
          float v36 = v25[v27][v29];
          v23.write(v36);
        }
      }
    }
...
void node3(
  ...
  loop8: for (int v43 = 0; v43 < 64; v43++) {
    loop9: for (int v44 = 0; v44 < 128; v44++) {
      loop10: for (int v45 = 0; v45 < 64; v45++) {
        ...
        float v47 = v42[v43][v44];
        float v48 = v38[v44][v45];
        if (v44 == 0) {
          v41[v43][v45] = v40;
        }
        float v49 = v41[v43][v45];
        float v50 = v47 * v48;
        float v51 = v49 + v50;
        v41[v43][v45] = v51;
        if ((v44 - 127) == 0) {
          float v52 = v41[v43][v45];
          v39.write(v52);
        }
      }
    }
...
void node4(
  ...
  loop11: for (int v59 = 0; v59 < 64; v59++) {
    loop12: for (int v60 = 0; v60 < 128; v60++) {
      loop13: for (int v61 = 0; v61 < 128; v61++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        if (v61 == 0) {
          float v62 = v53.read();
        ...
        float v63 = v58[v59][v60];
        float v64 = v54[v60][v61];
        if (v60 == 0) {
          v57[v59][v61] = v56;
        }
        float v65 = v57[v59][v61];
        float v66 = v63 * v64;
        float v67 = v65 + v66;
        v57[v59][v61] = v67;
        if ((v60 - 127) == 0) {
          float v68 = v57[v59][v61];
          v55.write(v68);
        }
      }
    }
...
void node5(
  ...
  loop14: for (int v75 = 0; v75 < 64; v75++) {
    loop15: for (int v76 = 0; v76 < 64; v76++) {
      loop16: for (int v77 = 0; v77 < 128; v77++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        if (v77 == 0) {
          float v78 = v69.read();
        ...
        float v79 = v74[v75][v76];
        float v80 = v70[v76][v77];
        if (v76 == 0) {
          v73[v75][v77] = v72;
        }
        float v81 = v73[v75][v77];
        float v82 = v79 * v80;
        float v83 = v81 + v82;
        v73[v75][v77] = v83;
        if ((v76 - 63) == 0) {
          float v84 = v73[v75][v77];
          v71.write(v84);
        }
      }
    }
...
void node7(
  ...
  loop20: for (int v106 = 0; v106 < 64; v106++) {
    loop21: for (int v107 = 0; v107 < 64; v107++) {
      loop22: for (int v108 = 0; v108 < 32; v108++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
...
void forward(
  ...
  hls::stream<float> v124("fifo_0");
	#pragma HLS STREAM variable=v124 depth=1024
  hls::stream<float> v125("fifo_1");
	#pragma HLS STREAM variable=v125 depth=2048
  hls::stream<float> v126("fifo_2");
	#pragma HLS STREAM variable=v126 depth=4096
  hls::stream<float> v127("fifo_3");
	#pragma HLS STREAM variable=v127 depth=8192
  hls::stream<float> v128("fifo_4");
	#pragma HLS STREAM variable=v128 depth=8192
