...
void node2(
  ...
  loop4: for (int v20 = 0; v20 < 512; v20++) {
    loop5: for (int v21 = 0; v21 < 256; v21++) {
      loop6: for (int v22 = 0; v22 < 128; v22++) {
        ...
        float v24 = v19[v20][v21];
        if (v20 == 0) {
          float v25 = v14.read();
          v18[v21][v22] = v25;
        }
        float v26 = v18[v21][v22];
        if (v21 == 0) {
          v17[v20][v22] = v16;
        }
        float v27 = v17[v20][v22];
        float v28 = v24 * v26;
        float v29 = v27 + v28;
        v17[v20][v22] = v29;
        if ((v21 - 255) == 0) {
          float v30 = v17[v20][v22];
          v15.write(v30);
        }
      }
    }
...
void node5(
  ...
  loop11: for (int v54 = 0; v54 < 512; v54++) {
    loop12: for (int v55 = 0; v55 < 128; v55++) {
      loop13: for (int v56 = 0; v56 < 256; v56++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        if (v56 == 0) {
          float v57 = v47.read();
        ...
        float v58 = v53[v54][v55];
        if (v54 == 0) {
          float v59 = v48.read();
          v52[v55][v56] = v59;
        }
        float v60 = v52[v55][v56];
        if (v55 == 0) {
          v51[v54][v56] = v50;
        }
        float v61 = v51[v54][v56];
        float v62 = v58 * v60;
        float v63 = v61 + v62;
        v51[v54][v56] = v63;
        if ((v55 - 127) == 0) {
          float v64 = v51[v54][v56];
          v49.write(v64);
        }
      }
    }
...
void forward(
  ...
  hls::stream<float> v83("fifo_2");
	#pragma HLS STREAM variable=v83 depth=32768
  hls::stream<float> v84("fifo_3");
	#pragma HLS STREAM variable=v84 depth=131072
  hls::stream<float> v85("fifo_4");
	#pragma HLS STREAM variable=v85 depth=131072
  hls::stream<float> v86("fifo_5");
	#pragma HLS STREAM variable=v86 depth=32768
  hls::stream<float> v87("fifo_6");
