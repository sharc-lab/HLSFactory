...
void node3(
  ...
  #pragma HLS array_partition variable=v46 cyclic dim=1 factor=3
        ...
        loop19: for (int v53 = 0; v53 < 5; v53++) {
          loop20: for (int v54 = 0; v54 < 10; v54++) {
            loop21: for (int v55 = 0; v55 < 3; v55++) {
              float v56 = v46[(v55 + (v52 * 3))][(v54 + (v51 * 10))];
              float v57 = v45[(v54 + (v51 * 10))][(v53 + (v50 * 5))];
              if ((v54 + (v51 * 10)) == 0) {
