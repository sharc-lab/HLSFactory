...
void node2(
  ...
  #pragma HLS array_partition variable=v17 cyclic dim=1 factor=16
  #pragma HLS array_partition variable=v17 cyclic dim=2 factor=8
      ...
      loop10: for (int v26 = 0; v26 < 16; v26++) {
        ...
        loop11: for (int v27 = 0; v27 < 2; v27++) {
          loop12: for (int v28 = 0; v28 < 8; v28++) {
            loop13: for (int v29 = 0; v29 < 16; v29++) {
              if ((v28 + (v25 * 8)) == 0) {
                float v30 = v18[v27][v29].read();
                v23[(v27 + (v24 * 2))][(v29 + (v26 * 16))] = v30;
              }
              float v31 = v23[(v27 + (v24 * 2))][(v29 + (v26 * 16))];
              if ((v27 + (v24 * 2)) == 0) {
                float v32 = v17[(v29 + (v26 * 16))][(v28 + (v25 * 8))];
                v22[(v29 + (v26 * 16))][(v28 + (v25 * 8))] = v32;
              }
              float v33 = v22[(v29 + (v26 * 16))][(v28 + (v25 * 8))];
              if ((v29 + (v26 * 16)) == 0) {
                v21[(v27 + (v24 * 2))][(v28 + (v25 * 8))] = v20;
              }
              float v34 = v21[(v27 + (v24 * 2))][(v28 + (v25 * 8))];
              float v35 = v31 * v33;
              float v36 = v34 + v35;
              v21[(v27 + (v24 * 2))][(v28 + (v25 * 8))] = v36;
              if (((v29 + (v26 * 16)) - 255) == 0) {
                float v37 = v21[(v27 + (v24 * 2))][(v28 + (v25 * 8))];
...
void node3(
  ...
  #pragma HLS array_partition variable=v39 cyclic dim=1 factor=16
...
void node5(
  ...
  #pragma HLS array_partition variable=v58 cyclic dim=2 factor=16
    ...
    loop23: for (int v66 = 0; v66 < 16; v66++) {
      loop24: for (int v67 = 0; v67 < 16; v67++) {
        ...
        loop25: for (int v68 = 0; v68 < 2; v68++) {
          loop26: for (int v69 = 0; v69 < 16; v69++) {
            loop27: for (int v70 = 0; v70 < 8; v70++) {
              if ((v69 + (v66 * 16)) == 0) {
                float v71 = v59[v68][v70].read();
                v64[(v68 + (v65 * 2))][(v70 + (v67 * 8))] = v71;
              }
              float v72 = v64[(v68 + (v65 * 2))][(v70 + (v67 * 8))];
              if ((v68 + (v65 * 2)) == 0) {
                float v73 = v58[(v70 + (v67 * 8))][(v69 + (v66 * 16))];
                v63[(v70 + (v67 * 8))][(v69 + (v66 * 16))] = v73;
              }
              float v74 = v63[(v70 + (v67 * 8))][(v69 + (v66 * 16))];
              if ((v70 + (v67 * 8)) == 0) {
                v62[(v68 + (v65 * 2))][(v69 + (v66 * 16))] = v61;
              }
              float v75 = v62[(v68 + (v65 * 2))][(v69 + (v66 * 16))];
              float v76 = v72 * v74;
              float v77 = v75 + v76;
              v62[(v68 + (v65 * 2))][(v69 + (v66 * 16))] = v77;
              if (((v70 + (v67 * 8)) - 127) == 0) {
                float v78 = v62[(v68 + (v65 * 2))][(v69 + (v66 * 16))];
                v60[v68][v69].write(v78);
              }
            }
          }
        }
...
void node6(
  ...
  #pragma HLS array_partition variable=v80 cyclic dim=1 factor=8
  #pragma HLS array_partition variable=v80 cyclic dim=2 factor=16
...
void forward(
  ...
  float v101[256][128];
  #pragma HLS array_partition variable=v101 cyclic dim=1 factor=16
  #pragma HLS array_partition variable=v101 cyclic dim=2 factor=8
