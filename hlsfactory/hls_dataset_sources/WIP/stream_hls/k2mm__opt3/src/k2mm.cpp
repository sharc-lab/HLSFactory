...
void node2(
  ...
  loop8: for (int v28 = 0; v28 < 90; v28++) {
    loop9: for (int v29 = 0; v29 < 20; v29++) {
      loop10: for (int v30 = 0; v30 < 19; v30++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        loop11: for (int v31 = 0; v31 < 2; v31++) {
          loop12: for (int v32 = 0; v32 < 11; v32++) {
            loop13: for (int v33 = 0; v33 < 10; v33++) {
              if ((v32 + (v29 * 11)) == 0) {
                float v34 = v22[v31][v33].read();
                v27[(v31 + (v28 * 2))][(v33 + (v30 * 10))] = v34;
              }
              float v35 = v27[(v31 + (v28 * 2))][(v33 + (v30 * 10))];
              float v36 = v23[(v33 + (v30 * 10))][(v32 + (v29 * 11))];
              if ((v33 + (v30 * 10)) == 0) {
                v26[(v31 + (v28 * 2))][(v32 + (v29 * 11))] = v25;
              }
              float v37 = v26[(v31 + (v28 * 2))][(v32 + (v29 * 11))];
              float v38 = v35 * v36;
              float v39 = v37 + v38;
              v26[(v31 + (v28 * 2))][(v32 + (v29 * 11))] = v39;
              if (((v33 + (v30 * 10)) - 189) == 0) {
                float v40 = v26[(v31 + (v28 * 2))][(v32 + (v29 * 11))];
                v24[v31][v32].write(v40);
              }
            }
          }
        }
...
void node3(
  ...
  loop14: for (int v46 = 0; v46 < 90; v46++) {
    loop15: for (int v47 = 0; v47 < 19; v47++) {
      loop16: for (int v48 = 0; v48 < 21; v48++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        loop17: for (int v49 = 0; v49 < 2; v49++) {
          loop18: for (int v50 = 0; v50 < 10; v50++) {
            loop19: for (int v51 = 0; v51 < 10; v51++) {
              float v52 = v42[(v49 + (v46 * 2))][(v51 + (v48 * 10))];
              float v53 = v41[(v51 + (v48 * 10))][(v50 + (v47 * 10))];
              if ((v51 + (v48 * 10)) == 0) {
                v45[(v49 + (v46 * 2))][(v50 + (v47 * 10))] = v44;
              }
              float v54 = v45[(v49 + (v46 * 2))][(v50 + (v47 * 10))];
              float v55 = v52 * v53;
              float v56 = v54 + v55;
              v45[(v49 + (v46 * 2))][(v50 + (v47 * 10))] = v56;
              if (((v51 + (v48 * 10)) - 209) == 0) {
                float v57 = v45[(v49 + (v46 * 2))][(v50 + (v47 * 10))];
                v43[v49][v50].write(v57);
              }
            }
          }
        }
