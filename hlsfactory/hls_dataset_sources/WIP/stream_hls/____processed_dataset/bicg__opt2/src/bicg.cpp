...
void node2(
  ...
  float v12[410];
  loop2: for (int v13 = 0; v13 < 390; v13++) {
    loop3: for (int v14 = 0; v14 < 410; v14++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      float v15 = v8[v14][v13];
      float v16 = v9[v13];
      if (v13 == 0) {
        v12[v14] = v11;
      }
...
void node3(
  ...
  float v25[390];
  loop4: for (int v26 = 0; v26 < 410; v26++) {
    loop5: for (int v27 = 0; v27 < 390; v27++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      float v28 = v21[v26];
      float v29 = v22[v26][v27];
      if (v26 == 0) {
        v25[v27] = v24;
      }
      float v30 = v25[v27];
