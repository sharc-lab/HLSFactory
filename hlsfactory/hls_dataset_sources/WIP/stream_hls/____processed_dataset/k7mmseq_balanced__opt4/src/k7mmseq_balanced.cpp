...
void node1(
  ...
  #pragma HLS array_partition variable=v7 cyclic dim=1 factor=4
  #pragma HLS array_partition variable=v7 cyclic dim=2 factor=4
    ...
    loop5: for (int v14 = 0; v14 < 16; v14++) {
      loop6: for (int v15 = 0; v15 < 16; v15++) {
        ...
        loop7: for (int v16 = 0; v16 < 4; v16++) {
          loop8: for (int v17 = 0; v17 < 4; v17++) {
            loop9: for (int v18 = 0; v18 < 4; v18++) {
              if ((v18 + (v15 * 4)) == 0) {
                float v19 = v8[v16][v17].read();
                v12[(v16 + (v13 * 4))][(v17 + (v14 * 4))] = v19;
              }
              float v20 = v12[(v16 + (v13 * 4))][(v17 + (v14 * 4))];
              float v21 = v7[(v17 + (v14 * 4))][(v18 + (v15 * 4))];
              if ((v17 + (v14 * 4)) == 0) {
                v11[(v16 + (v13 * 4))][(v18 + (v15 * 4))] = v10;
              }
              float v22 = v11[(v16 + (v13 * 4))][(v18 + (v15 * 4))];
              float v23 = v20 * v21;
              float v24 = v22 + v23;
              v11[(v16 + (v13 * 4))][(v18 + (v15 * 4))] = v24;
              if (((v17 + (v14 * 4)) - 63) == 0) {
                float v25 = v11[(v16 + (v13 * 4))][(v18 + (v15 * 4))];
...
void node2(
  float v26[64][64],
  hls::stream<float> v27[4][4],
  hls::stream<float> v28[4][4],
  float v29
) {
  #pragma HLS array_partition variable=v26 cyclic dim=1 factor=4
  #pragma HLS array_partition variable=v26 cyclic dim=2 factor=4

  float v30[64][64];
  #pragma HLS array_partition variable=v30 cyclic dim=1 factor=4
  #pragma HLS array_partition variable=v30 cyclic dim=2 factor=4
      ...
      loop12: for (int v34 = 0; v34 < 16; v34++) {
        ...
        loop13: for (int v35 = 0; v35 < 4; v35++) {
          loop14: for (int v36 = 0; v36 < 4; v36++) {
            loop15: for (int v37 = 0; v37 < 4; v37++) {
              if ((v37 + (v34 * 4)) == 0) {
                float v38 = v27[v35][v36].read();
                v31[(v35 + (v32 * 4))][(v36 + (v33 * 4))] = v38;
              }
              float v39 = v31[(v35 + (v32 * 4))][(v36 + (v33 * 4))];
              float v40 = v26[(v36 + (v33 * 4))][(v37 + (v34 * 4))];
              if ((v36 + (v33 * 4)) == 0) {
                v30[(v35 + (v32 * 4))][(v37 + (v34 * 4))] = v29;
              }
              float v41 = v30[(v35 + (v32 * 4))][(v37 + (v34 * 4))];
              float v42 = v39 * v40;
              float v43 = v41 + v42;
              v30[(v35 + (v32 * 4))][(v37 + (v34 * 4))] = v43;
              if (((v36 + (v33 * 4)) - 63) == 0) {
                float v44 = v30[(v35 + (v32 * 4))][(v37 + (v34 * 4))];
...
void node3(
  ...
  loop16: for (int v51 = 0; v51 < 16; v51++) {
    loop17: for (int v52 = 0; v52 < 16; v52++) {
...
void node4(
  ...
  loop22: for (int v70 = 0; v70 < 16; v70++) {
    loop23: for (int v71 = 0; v71 < 16; v71++) {
      loop24: for (int v72 = 0; v72 < 16; v72++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        loop25: for (int v73 = 0; v73 < 4; v73++) {
          loop26: for (int v74 = 0; v74 < 4; v74++) {
            loop27: for (int v75 = 0; v75 < 4; v75++) {
              if ((v75 + (v72 * 4)) == 0) {
                float v76 = v65[v73][v74].read();
                v69[(v73 + (v70 * 4))][(v74 + (v71 * 4))] = v76;
              }
              float v77 = v69[(v73 + (v70 * 4))][(v74 + (v71 * 4))];
              float v78 = v64[(v74 + (v71 * 4))][(v75 + (v72 * 4))];
              if ((v74 + (v71 * 4)) == 0) {
      ...
      loop30: for (int v91 = 0; v91 < 16; v91++) {
        ...
        loop31: for (int v92 = 0; v92 < 4; v92++) {
          loop32: for (int v93 = 0; v93 < 4; v93++) {
            loop33: for (int v94 = 0; v94 < 4; v94++) {
              if ((v94 + (v91 * 4)) == 0) {
                float v95 = v83[v92][v93].read();
                v88[(v92 + (v89 * 4))][(v93 + (v90 * 4))] = v95;
              }
              float v96 = v88[(v92 + (v89 * 4))][(v93 + (v90 * 4))];
              float v97 = v84[(v93 + (v90 * 4))][(v94 + (v91 * 4))];
              if ((v93 + (v90 * 4)) == 0) {
                v87[(v92 + (v89 * 4))][(v94 + (v91 * 4))] = v86;
              }
              float v98 = v87[(v92 + (v89 * 4))][(v94 + (v91 * 4))];
              float v99 = v96 * v97;
              float v100 = v98 + v99;
              v87[(v92 + (v89 * 4))][(v94 + (v91 * 4))] = v100;
              if (((v93 + (v90 * 4)) - 63) == 0) {
                float v101 = v87[(v92 + (v89 * 4))][(v94 + (v91 * 4))];
...
void node6(
  ...
  #pragma HLS array_partition variable=v103 cyclic dim=1 factor=4
  #pragma HLS array_partition variable=v103 cyclic dim=2 factor=4
        ...
        loop37: for (int v111 = 0; v111 < 4; v111++) {
          loop38: for (int v112 = 0; v112 < 4; v112++) {
            loop39: for (int v113 = 0; v113 < 4; v113++) {
              if ((v113 + (v110 * 4)) == 0) {
                float v114 = v102[v111][v112].read();
                v107[(v111 + (v108 * 4))][(v112 + (v109 * 4))] = v114;
              }
              float v115 = v107[(v111 + (v108 * 4))][(v112 + (v109 * 4))];
              float v116 = v103[(v112 + (v109 * 4))][(v113 + (v110 * 4))];
              if ((v112 + (v109 * 4)) == 0) {
                v106[(v111 + (v108 * 4))][(v113 + (v110 * 4))] = v105;
              }
              float v117 = v106[(v111 + (v108 * 4))][(v113 + (v110 * 4))];
              float v118 = v115 * v116;
              float v119 = v117 + v118;
              v106[(v111 + (v108 * 4))][(v113 + (v110 * 4))] = v119;
              if (((v112 + (v109 * 4)) - 63) == 0) {
                float v120 = v106[(v111 + (v108 * 4))][(v113 + (v110 * 4))];
                v104[v111][v113].write(v120);
              }
            }
          }
        }
        ...
        loop43: for (int v129 = 0; v129 < 4; v129++) {
          loop44: for (int v130 = 0; v130 < 4; v130++) {
            loop45: for (int v131 = 0; v131 < 4; v131++) {
              float v132 = v122[(v129 + (v126 * 4))][(v130 + (v127 * 4))];
              float v133 = v121[(v130 + (v127 * 4))][(v131 + (v128 * 4))];
              if ((v130 + (v127 * 4)) == 0) {
                v125[(v129 + (v126 * 4))][(v131 + (v128 * 4))] = v124;
              }
              float v134 = v125[(v129 + (v126 * 4))][(v131 + (v128 * 4))];
              float v135 = v132 * v133;
              float v136 = v134 + v135;
              v125[(v129 + (v126 * 4))][(v131 + (v128 * 4))] = v136;
              if (((v130 + (v127 * 4)) - 63) == 0) {
                float v137 = v125[(v129 + (v126 * 4))][(v131 + (v128 * 4))];
                v123[v129][v131].write(v137);
              }
            }
          }
        }
...
void forward(
  ...
  node7(v139, v138, v153, 0.000000);
  node6(v153, v140, v152, 0.000000);
  node5(v152, v141, v151, 0.000000);
  node4(v142, v151, v150, 0.000000);
  node3(v143, v150, v149, 0.000000);
  node2(v144, v149, v148, 0.000000);
  node1(v145, v148, v147, 0.000000);
  node0(v147, v146);
  return ;
}
