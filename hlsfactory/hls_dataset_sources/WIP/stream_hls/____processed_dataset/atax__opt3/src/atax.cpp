...
void node1(
  float v5[410][390],
  hls::stream<float> v6[15],
  hls::stream<float> v7[10],
  float v8
) {
  #pragma HLS array_partition variable=v5 cyclic dim=1 factor=10
  #pragma HLS array_partition variable=v5 cyclic dim=2 factor=15
  ...
  loop2: for (int v11 = 0; v11 < 41; v11++) {
    loop3: for (int v12 = 0; v12 < 26; v12++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      loop4: for (int v13 = 0; v13 < 10; v13++) {
        loop5: for (int v14 = 0; v14 < 15; v14++) {
          float v15 = v5[(v13 + (v11 * 10))][(v14 + (v12 * 15))];
          if ((v13 + (v11 * 10)) == 0) {
            float v16 = v6[v14].read();
            v10[(v14 + (v12 * 15))] = v16;
          }
          float v17 = v10[(v14 + (v12 * 15))];
          if ((v14 + (v12 * 15)) == 0) {
            v9[(v13 + (v11 * 10))] = v8;
          }
          float v18 = v9[(v13 + (v11 * 10))];
          float v19 = v15 * v17;
          float v20 = v18 + v19;
          v9[(v13 + (v11 * 10))] = v20;
          if (((v14 + (v12 * 15)) - 389) == 0) {
            float v21 = v9[(v13 + (v11 * 10))];
            v7[v13].write(v21);
          }
        }
      }
...
void node3(
  ...
  loop10: for (int v34 = 0; v34 < 26; v34++) {
    loop11: for (int v35 = 0; v35 < 41; v35++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      loop12: for (int v36 = 0; v36 < 15; v36++) {
        loop13: for (int v37 = 0; v37 < 10; v37++) {
          float v38 = v29[(v36 + (v34 * 15))][(v37 + (v35 * 10))];
          float v39 = v30[(v37 + (v35 * 10))];
          if ((v37 + (v35 * 10)) == 0) {
            v33[(v36 + (v34 * 15))] = v32;
          }
          float v40 = v33[(v36 + (v34 * 15))];
          float v41 = v38 * v39;
          float v42 = v40 + v41;
          v33[(v36 + (v34 * 15))] = v42;
          if (((v37 + (v35 * 10)) - 409) == 0) {
            float v43 = v33[(v36 + (v34 * 15))];
            v31[v36].write(v43);
          }
        }
      }
...
void forward(
  ...
  #pragma HLS array_partition variable=v48 cyclic dim=2 factor=15

  hls::stream<float> v49[15];
	#pragma HLS STREAM variable=v49 depth=26
  node3(v44, v45, v49, 0.000000);
  node2(v44, v48);
  node1(v48, v49, v47, 0.000000);
  node0(v47, v46);
  return ;
}
