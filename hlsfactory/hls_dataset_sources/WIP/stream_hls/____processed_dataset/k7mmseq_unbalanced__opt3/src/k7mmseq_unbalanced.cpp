...
void node1(
  ...
  #pragma HLS array_partition variable=v7 cyclic dim=1 factor=2
    ...
    loop5: for (int v14 = 0; v14 < 16; v14++) {
      loop6: for (int v15 = 0; v15 < 16; v15++) {
        ...
        loop7: for (int v16 = 0; v16 < 4; v16++) {
          loop8: for (int v17 = 0; v17 < 1; v17++) {
            loop9: for (int v18 = 0; v18 < 2; v18++) {
              if ((v14 + v17) == 0) {
                float v19 = v8[v16][v18].read();
                v12[(v16 + (v13 * 4))][(v18 + (v15 * 2))] = v19;
              }
              float v20 = v12[(v16 + (v13 * 4))][(v18 + (v15 * 2))];
              float v21 = v7[(v18 + (v15 * 2))][(v14 + v17)];
              if ((v18 + (v15 * 2)) == 0) {
                v11[(v16 + (v13 * 4))][(v14 + v17)] = v10;
              }
              float v22 = v11[(v16 + (v13 * 4))][(v14 + v17)];
              float v23 = v20 * v21;
              float v24 = v22 + v23;
              v11[(v16 + (v13 * 4))][(v14 + v17)] = v24;
              if (((v18 + (v15 * 2)) - 31) == 0) {
                float v25 = v11[(v16 + (v13 * 4))][(v14 + v17)];
                v9[v16][v17].write(v25);
              }
            }
          }
        }
    ...
    loop11: for (int v33 = 0; v33 < 16; v33++) {
      loop12: for (int v34 = 0; v34 < 16; v34++) {
        ...
        loop13: for (int v35 = 0; v35 < 4; v35++) {
          loop14: for (int v36 = 0; v36 < 2; v36++) {
            loop15: for (int v37 = 0; v37 < 4; v37++) {
              if ((v36 + (v33 * 2)) == 0) {
                float v38 = v26[v35][v37].read();
                v31[(v35 + (v32 * 4))][(v37 + (v34 * 4))] = v38;
              }
              float v39 = v31[(v35 + (v32 * 4))][(v37 + (v34 * 4))];
              float v40 = v27[(v37 + (v34 * 4))][(v36 + (v33 * 2))];
              if ((v37 + (v34 * 4)) == 0) {
                v30[(v35 + (v32 * 4))][(v36 + (v33 * 2))] = v29;
              }
              float v41 = v30[(v35 + (v32 * 4))][(v36 + (v33 * 2))];
              float v42 = v39 * v40;
              float v43 = v41 + v42;
              v30[(v35 + (v32 * 4))][(v36 + (v33 * 2))] = v43;
              if (((v37 + (v34 * 4)) - 63) == 0) {
                float v44 = v30[(v35 + (v32 * 4))][(v36 + (v33 * 2))];
                v28[v35][v36].write(v44);
              }
            }
          }
        }
...
void node3(
  ...
  loop16: for (int v51 = 0; v51 < 16; v51++) {
    loop17: for (int v52 = 0; v52 < 16; v52++) {
      loop18: for (int v53 = 0; v53 < 32; v53++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        loop19: for (int v54 = 0; v54 < 4; v54++) {
          loop20: for (int v55 = 0; v55 < 4; v55++) {
            loop21: for (int v56 = 0; v56 < 4; v56++) {
              if ((v55 + (v52 * 4)) == 0) {
                float v57 = v46[v54][v56].read();
                v50[(v54 + (v51 * 4))][(v56 + (v53 * 4))] = v57;
              }
              float v58 = v50[(v54 + (v51 * 4))][(v56 + (v53 * 4))];
              float v59 = v45[(v56 + (v53 * 4))][(v55 + (v52 * 4))];
              if ((v56 + (v53 * 4)) == 0) {
                v49[(v54 + (v51 * 4))][(v55 + (v52 * 4))] = v48;
              }
              float v60 = v49[(v54 + (v51 * 4))][(v55 + (v52 * 4))];
              float v61 = v58 * v59;
              float v62 = v60 + v61;
              v49[(v54 + (v51 * 4))][(v55 + (v52 * 4))] = v62;
              if (((v56 + (v53 * 4)) - 127) == 0) {
                float v63 = v49[(v54 + (v51 * 4))][(v55 + (v52 * 4))];
                v47[v54][v55].write(v63);
              }
            }
          }
        }
      ...
      loop24: for (int v72 = 0; v72 < 16; v72++) {
        ...
        loop25: for (int v73 = 0; v73 < 4; v73++) {
          loop26: for (int v74 = 0; v74 < 4; v74++) {
            loop27: for (int v75 = 0; v75 < 8; v75++) {
              if ((v74 + (v71 * 4)) == 0) {
                float v76 = v64[v73][v75].read();
                v69[(v73 + (v70 * 4))][(v75 + (v72 * 8))] = v76;
              }
              float v77 = v69[(v73 + (v70 * 4))][(v75 + (v72 * 8))];
              float v78 = v65[(v75 + (v72 * 8))][(v74 + (v71 * 4))];
              if ((v75 + (v72 * 8)) == 0) {
                v68[(v73 + (v70 * 4))][(v74 + (v71 * 4))] = v67;
              }
              float v79 = v68[(v73 + (v70 * 4))][(v74 + (v71 * 4))];
              float v80 = v77 * v78;
              float v81 = v79 + v80;
              v68[(v73 + (v70 * 4))][(v74 + (v71 * 4))] = v81;
              if (((v75 + (v72 * 8)) - 127) == 0) {
                float v82 = v68[(v73 + (v70 * 4))][(v74 + (v71 * 4))];
                v66[v73][v74].write(v82);
              }
            }
          }
        }
    ...
    loop29: for (int v90 = 0; v90 < 16; v90++) {
      loop30: for (int v91 = 0; v91 < 16; v91++) {
        ...
        loop31: for (int v92 = 0; v92 < 4; v92++) {
          loop32: for (int v93 = 0; v93 < 8; v93++) {
            loop33: for (int v94 = 0; v94 < 4; v94++) {
              if ((v93 + (v90 * 8)) == 0) {
                float v95 = v84[v92][v94].read();
                v88[(v92 + (v89 * 4))][(v94 + (v91 * 4))] = v95;
              }
              float v96 = v88[(v92 + (v89 * 4))][(v94 + (v91 * 4))];
              float v97 = v83[(v94 + (v91 * 4))][(v93 + (v90 * 8))];
              if ((v94 + (v91 * 4)) == 0) {
                v87[(v92 + (v89 * 4))][(v93 + (v90 * 8))] = v86;
              }
              float v98 = v87[(v92 + (v89 * 4))][(v93 + (v90 * 8))];
              float v99 = v96 * v97;
              float v100 = v98 + v99;
              v87[(v92 + (v89 * 4))][(v93 + (v90 * 8))] = v100;
              if (((v94 + (v91 * 4)) - 63) == 0) {
                float v101 = v87[(v92 + (v89 * 4))][(v93 + (v90 * 8))];
                v85[v92][v93].write(v101);
              }
            }
          }
        }
...
void node7(
  ...
  #pragma HLS array_partition variable=v121 cyclic dim=1 factor=2
        ...
        loop43: for (int v129 = 0; v129 < 4; v129++) {
          loop44: for (int v130 = 0; v130 < 4; v130++) {
            loop45: for (int v131 = 0; v131 < 2; v131++) {
              float v132 = v122[(v129 + (v126 * 4))][(v131 + (v128 * 2))];
              float v133 = v121[(v131 + (v128 * 2))][(v130 + (v127 * 4))];
              if ((v131 + (v128 * 2)) == 0) {
