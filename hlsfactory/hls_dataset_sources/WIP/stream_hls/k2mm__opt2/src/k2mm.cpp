...
void node1(
  ...
  loop2: for (int v10 = 0; v10 < 220; v10++) {
    loop3: for (int v11 = 0; v11 < 180; v11++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      float v12 = v5.read();
      float v13 = v6[v11][v10];
      float v14 = v8;
      float v15 = v13 * v14;
      float v16 = v12 * v9;
      float v17 = v16 + v15;
...
void node2(
  ...
  float v22[180][220];
  float v23[180][190];
  loop4: for (int v24 = 0; v24 < 190; v24++) {
    loop5: for (int v25 = 0; v25 < 220; v25++) {
      loop6: for (int v26 = 0; v26 < 180; v26++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        if (v25 == 0) {
          float v27 = v18.read();
        ...
        float v28 = v23[v26][v24];
        float v29 = v19[v24][v25];
        if (v24 == 0) {
          v22[v26][v25] = v21;
        }
        float v30 = v22[v26][v25];
        float v31 = v28 * v29;
        float v32 = v30 + v31;
        v22[v26][v25] = v32;
        if ((v24 - 189) == 0) {
          float v33 = v22[v26][v25];
          v20.write(v33);
        }
      }
    }
...
void node3(
  ...
  float v38[180][190];
  loop7: for (int v39 = 0; v39 < 190; v39++) {
    loop8: for (int v40 = 0; v40 < 210; v40++) {
      loop9: for (int v41 = 0; v41 < 180; v41++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        float v42 = v34[v41][v40];
        float v43 = v35[v40][v39];
        if (v40 == 0) {
          v38[v41][v39] = v37;
        }
        float v44 = v38[v41][v39];
        float v45 = v42 * v43;
        float v46 = v44 + v45;
        v38[v41][v39] = v46;
        if ((v40 - 209) == 0) {
          float v47 = v38[v41][v39];
          v36.write(v47);
        }
      }
    }
